...
*/
(function(){function na(h,m){h.prototype=ab(m.prototype);h.prototype.constructor=h;h.base=m.prototype}function ab(h){function m(){}m.prototype=h;return new m}function Ta(h,m,w){"millisecond"===w?h.setMilliseconds(h.getMilliseconds()+1*m):"second"===w?h.setSeconds(h.getSeconds()+1*m):"minute"===w?h.setMinutes(h.getMinutes()+1*m):"hour"===w?h.setHours(h.getHours()+1*m):"day"===w?h.setDate(h.getDate()+1*m):"week"===w?h.setDate(h.getDate()+7*m):"month"===w?h.setMonth(h.getMonth()+1*m):"year"===w&&h.setFullYear(h.getFullYear()+
1*m);return h}function X(h,m){var w=!1;0>h&&(w=!0,h*=-1);h=""+h;for(m=m?m:1;h.length<m;)h="0"+h;return w?"-"+h:h}function Da(h){if(!h)return h;h=h.replace(/^\s\s*/,"");for(var m=/\s/,w=h.length;m.test(h.charAt(--w)););return h.slice(0,w+1)}function za(h){h.roundRect=function(h,w,s,v,pa,E,y,F){y&&(this.fillStyle=y);F&&(this.strokeStyle=F);"undefined"===typeof pa&&(pa=5);this.lineWidth=E;this.beginPath();this.moveTo(h+pa,w);this.lineTo(h+s-pa,w);this.quadraticCurveTo(h+s,w,h+s,w+pa);this.lineTo(h+s,
...
500>=(new Date).getTime()-h._dropDownCloseTime.getTime()||(h._dropdownMenu.style.display="block",h._menuButton.blur(),h._dropdownMenu.focus())},h.allDOMEventHandlers,!0);U(h._menuButton,"mouseover",function(){m||(ga(h._menuButton,{backgroundColor:h.toolbar.itemBackgroundColorOnHover,color:h.toolbar.fontColorOnHover}),0>=navigator.userAgent.search("MSIE")&&ga(h._menuButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},h.allDOMEventHandlers,!0);U(h._menuButton,"mouseout",function(){m||
(ga(h._menuButton,{backgroundColor:h.toolbar.itemBackgroundColor,color:h.toolbar.fontColor}),0>=navigator.userAgent.search("MSIE")&&ga(h._menuButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"}))},h.allDOMEventHandlers,!0)}if(h.exportEnabled&&h._dropdownMenu){ga(h._dropdownMenu,{backgroundColor:h.toolbar.itemBackgroundColor,color:h.toolbar.fontColor});for(var w=h._dropdownMenu.childNodes,s=0;s<w.length;s++)ga(w[s],{backgroundColor:h.toolbar.itemBackgroundColor,color:h.toolbar.fontColor})}else!h._dropdownMenu&&
...
var w=document.createElement("canvas");w.setAttribute("class","canvasjs-chart-canvas");Ja(w,h,m);v||"undefined"===typeof G_vmlCanvasManager||G_vmlCanvasManager.initElement(w);return w}function ga(h,m){for(var w in m)h.style[w]=m[w]}function ta(h,m,w){m.getAttribute("state")||(m.style.backgroundColor=h.toolbar.itemBackgroundColor,m.style.color=h.toolbar.fontColor,m.style.border="none",ga(m,{WebkitUserSelect:"none",MozUserSelect:"none",msUserSelect:"none",userSelect:"none"}));m.getAttribute("state")!==
w&&(m.setAttribute("state",w),m.setAttribute("type","button"),ga(m,{padding:"5px 12px",cursor:"pointer","float":"left",width:"40px",height:"25px",outline:"0px",verticalAlign:"baseline",lineHeight:"0"}),m.setAttribute("title",h._cultureInfo[w+"Text"]),m.innerHTML="<img style='height:95%; pointer-events: none;' src='"+hb[w].image+"' alt='"+h._cultureInfo[w+"Text"]+"' />")}function Ia(){for(var h=null,m=0;m<arguments.length;m++)h=arguments[m],h.style&&(h.style.display="inline")}function sa(){for(var h=
...
H,$,S,da,ha;$="#333333";S="#000000";H="#666666";ha=da="#000000";var T=20,F=14,Sa={colorSet:"colorSet1",backgroundColor:"#FFFFFF",title:{fontFamily:Ca,fontSize:32,fontColor:$,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:Ca,fontSize:F,fontColor:$,fontWeight:"normal",verticalAlign:"top",margin:5}],data:[{indexLabelFontFamily:y,indexLabelFontSize:F,indexLabelFontColor:$,indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:y,titleFontSize:T,titleFontColor:$,
titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:S,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:0,gridColor:H,stripLines:[{labelFontFamily:y,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:F,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:ha,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",
spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisX2:[{titleFontFamily:y,titleFontSize:T,titleFontColor:$,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:S,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:0,gridColor:H,stripLines:[{labelFontFamily:y,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:F,
labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:ha,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY:[{titleFontFamily:y,titleFontSize:T,titleFontColor:$,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:S,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:1,gridColor:H,stripLines:[{labelFontFamily:y,labelFontSize:F,
labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:F,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:ha,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY2:[{titleFontFamily:y,titleFontSize:T,titleFontColor:$,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:S,
...
T=20;F=14;Ca={colorSet:"colorSet12",backgroundColor:"#2A2A2A",title:{fontFamily:Ca,fontSize:32,fontColor:$,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:Ca,fontSize:F,fontColor:$,fontWeight:"normal",verticalAlign:"top",margin:5}],toolbar:{itemBackgroundColor:"#666666",itemBackgroundColorOnHover:"#FF7372",buttonBorderColor:"#FF7372",buttonBorderThickness:1,fontColor:"#F5F5F5",fontColorOnHover:"#F5F5F5"},data:[{indexLabelFontFamily:y,indexLabelFontSize:F,indexLabelFontColor:S,
...
labelFontWeight:"normal",labelBackgroundColor:ha,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisX2:[{titleFontFamily:y,titleFontSize:T,titleFontColor:S,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:S,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:0,gridColor:H,stripLines:[{labelFontFamily:y,labelFontSize:F,labelFontColor:"#FF7300",
labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:F,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:ha,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisY:[{titleFontFamily:y,titleFontSize:T,titleFontColor:S,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:S,labelFontWeight:"normal",
...
axisY2:[{titleFontFamily:y,titleFontSize:T,titleFontColor:S,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:S,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:1,gridColor:H,stripLines:[{labelFontFamily:y,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:F,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:ha,
...
dark2:{colorSet:"colorSet2",backgroundColor:"#32373A",title:{fontFamily:y,fontSize:32,fontColor:$,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:y,fontSize:F,fontColor:$,fontWeight:"normal",verticalAlign:"top",margin:5}],toolbar:{itemBackgroundColor:"#666666",itemBackgroundColorOnHover:"#FF7372",buttonBorderColor:"#FF7372",buttonBorderThickness:1,fontColor:"#F5F5F5",fontColorOnHover:"#F5F5F5"},data:[{indexLabelFontFamily:y,indexLabelFontSize:F,indexLabelFontColor:S,indexLabelFontWeight:"normal",
indexLabelLineThickness:1}],axisX:[{titleFontFamily:y,titleFontSize:T,titleFontColor:S,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:S,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:0,gridColor:H,stripLines:[{labelFontFamily:y,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:F,labelFontColor:"#000000",labelFontWeight:"normal",
labelBackgroundColor:ha,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisX2:[{titleFontFamily:y,titleFontSize:T,titleFontColor:S,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:S,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:0,gridColor:H,stripLines:[{labelFontFamily:y,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",
labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:F,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:ha,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisY:[{titleFontFamily:y,titleFontSize:T,titleFontColor:S,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:S,labelFontWeight:"normal",lineThickness:0,
...
titleFontSize:T,titleFontColor:S,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:S,labelFontWeight:"normal",lineThickness:0,lineColor:H,tickThickness:1,tickColor:H,gridThickness:1,gridColor:H,stripLines:[{labelFontFamily:y,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:F,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:ha,color:da,thickness:1,
lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],legend:{fontFamily:y,fontSize:14,fontColor:$,fontWeight:"bold",verticalAlign:"bottom",horizontalAlign:"center"},toolTip:{fontFamily:y,fontSize:14,fontStyle:"normal",cornerRadius:0,borderThickness:1,fontColor:S,backgroundColor:"rgba(0, 0, 0, .7)"}},theme1:Sa,theme2:Ya,theme3:Sa},R={numberDuration:1,yearDuration:314496E5,monthDuration:2592E6,weekDuration:6048E5,dayDuration:864E5,
hourDuration:36E5,minuteDuration:6E4,secondDuration:1E3,millisecondDuration:1,dayOfWeekFromInt:"Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ")};(function(){J.fSDec=function(h){for(var m="",w=0;w<h.length;w++)m+=String.fromCharCode(h[w]-111);return m};J.str={ncv:[189,222,221,156,178,222,220,220,212,225,210,216,208,219,143,197,212,225,226,216,222,221],fntStr:[223,231,143,178,208,219,216,209,225,216,155,143,187,228,210,216,211,208,143,182,225,208,221,211,212,155,143,187,228,210,
216,211,208,143,194,208,221,226,143,196,221,216,210,222,211,212,155,143,176,225,216,208,219,155,143,226,208,221,226,156,226,212,225,216,213],tBl:[227,212,231,227,177,208,226,212,219,216,221,212],fnt:[213,222,221,227],fSy:[213,216,219,219,194,227,232,219,212],fTx:[213,216,219,219,195,212,231,227],gr:[214,225,212,232],ct:[210,227,231],tp:[227,222,223]};delete oa[J.fSDec([178,215,208,225,227])][J.fSDec([210,225,212,211,216,227,183,225,212,213])];J.pro={sCH:oa[J.fSDec([178,215,208,225,227])][J.fSDec([210,
225,212,211,216,227,183,225,212,213])]};J._fTWm=function(h){if("undefined"===typeof J.pro.sCH&&!$a){var m=h[J.fSDec(J.str.ct)];m[J.fSDec(J.str.tBl)]=J.fSDec(J.str.tp);m[J.fSDec(J.str.fnt)]=11+J.fSDec(J.str.fntStr);m[J.fSDec(J.str.fSy)]=J.fSDec(J.str.gr);m[J.fSDec(J.str.fTx)](J.fSDec(J.str.ncv),2,h.height-11-2)}}})();var db=function(){var h=!1;try{var m=Object.defineProperty&&Object.defineProperty({},"passive",{get:function(){h=!0;return!1}});window.addEventListener&&(window.addEventListener("test",
null,m),window.removeEventListener("test",null,m))}catch(w){h=!1}return h}(),Va={},ua=null,ib=function(){this.ctx.clearRect(0,0,this.width,this.height);this.backgroundColor&&(this.ctx.fillStyle=this.backgroundColor,this.ctx.fillRect(0,0,this.width,this.height))},jb=function(h,m,w){m=Math.min(this.width,this.height);return Math.max("theme4"===this.theme?0:300<=m?12:11,Math.round(m*(h/400)))},ya=function(){var h=/D{1,4}|M{1,4}|Y{1,4}|h{1,2}|H{1,2}|m{1,2}|s{1,2}|f{1,3}|t{1,2}|T{1,2}|K|z{1,3}|"[^"]*"|'[^']*'/g,
m="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),w="Sun Mon Tue Wed Thu Fri Sat".split(" "),s="January February March April May June July August September October November December".split(" "),v="Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),y=/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g,E=/[^-+\dA-Z]/g;return function(F,O,N){var H=N?N.days:m,Q=N?N.months:s,U=N?N.shortDays:
w,R=N?N.shortMonths:v;N="";var J=!1;F=F&&F.getTime?F:F?new Date(F):new Date;if(isNaN(F))throw SyntaxError("invalid date");"UTC:"===O.slice(0,4)&&(O=O.slice(4),J=!0);N=J?"getUTC":"get";var V=F[N+"Date"](),L=F[N+"Day"](),W=F[N+"Month"](),a=F[N+"FullYear"](),d=F[N+"Hours"](),c=F[N+"Minutes"](),b=F[N+"Seconds"](),e=F[N+"Milliseconds"](),f=J?0:F.getTimezoneOffset();return N=O.replace(h,function(l){switch(l){case "D":return V;case "DD":return X(V,2);case "DDD":return U[L];case "DDDD":return H[L];case "M":return W+
...
3).slice(0,3);case "t":return 12>d?"a":"p";case "tt":return 12>d?"am":"pm";case "T":return 12>d?"A":"P";case "TT":return 12>d?"AM":"PM";case "K":return J?"UTC":(String(F).match(y)||[""]).pop().replace(E,"");case "z":return(0<f?"-":"+")+Math.floor(Math.abs(f)/60);case "zz":return(0<f?"-":"+")+X(Math.floor(Math.abs(f)/60),2);case "zzz":return(0<f?"-":"+")+X(Math.floor(Math.abs(f)/60),2)+X(Math.abs(f)%60,2);default:return l.slice(1,l.length-1)}})}}(),ea=function(h,m,w){if(null===h)return"";if(!isFinite(h))return h;
h=Number(h);var s=0>h?!0:!1;s&&(h*=-1);var v=w?w.decimalSeparator:".",y=w?w.digitGroupSeparator:",",E="";m=String(m);var E=1,F=w="",O=-1,N=[],H=[],Q=0,J=0,U=0,R=!1,V=0,F=m.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);m=null;for(var L=0;F&&L<F.length;L++)if(m=F[L],"."===m&&0>O)O=L;else{if("%"===m)E*=100;else if("\u2030"===m){E*=1E3;continue}else if(","===m[0]&&"."===m[m.length-1]){E/=Math.pow(1E3,m.length-1);O=L+m.length-1;continue}else"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||(R=!0);
0>O?(N.push(m),"#"===m||"0"===m?Q++:","===m&&U++):(H.push(m),"#"!==m&&"0"!==m||J++)}R&&(m=Math.floor(h),F=-Math.floor(Math.log(h)/Math.LN10+1),V=0===h?0:0===m?-(Q+F):String(m).length-Q,E/=Math.pow(10,V));0>O&&(O=L);E=(h*E).toFixed(J);m=E.split(".");E=(m[0]+"").split("");h=(m[1]+"").split("");E&&"0"===E[0]&&E.shift();for(R=F=L=J=O=0;0<N.length;)if(m=N.pop(),"#"===m||"0"===m)if(O++,O===Q){var W=E,E=[];if("0"===m)for(m=Q-J-(W?W.length:0);0<m;)W.unshift("0"),m--;for(;0<W.length;)w=W.pop()+w,R++,0===R%
F&&(L===U&&0<W.length)&&(w=y+w)}else 0<E.length?(w=E.pop()+w,J++,R++):"0"===m&&(w="0"+w,J++,R++),0===R%F&&(L===U&&0<E.length)&&(w=y+w);else"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||!/[eE][+-]*[0]+/.test(m)?","===m?(L++,F=R,R=0,0<E.length&&(w=y+w)):w=1<m.length&&('"'===m[0]&&'"'===m[m.length-1]||"'"===m[0]&&"'"===m[m.length-1])?m.slice(1,m.length-1)+w:m+w:(m=0>V?m.replace("+","").replace("-",""):m.replace("-",""),w+=m.replace(/[0]+/,function(a){return X(V,a.length)}));y="";for(N=!1;0<H.length;)m=
H.shift(),"#"===m||"0"===m?0<h.length&&0!==Number(h.join(""))?(y+=h.shift(),N=!0):"0"===m&&(y+="0",N=!0):1<m.length&&('"'===m[0]&&'"'===m[m.length-1]||"'"===m[0]&&"'"===m[m.length-1])?y+=m.slice(1,m.length-1):"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||!/[eE][+-]*[0]+/.test(m)?y+=m:(m=0>V?m.replace("+","").replace("-",""):m.replace("-",""),y+=m.replace(/[0]+/,function(a){return X(V,a.length)}));w+=(N?v:"")+y;return s?"-"+w:w},La=function(h){var m=0,w=0;h=h||window.event;h.offsetX||0===h.offsetX?
(m=h.offsetX,w=h.offsetY):h.layerX||0==h.layerX?(m=h.layerX,w=h.layerY):(m=h.pageX-h.target.offsetLeft,w=h.pageY-h.target.offsetTop);return{x:m,y:w}},Xa=!0,Oa=window.devicePixelRatio||1,Ka=1,ka=Xa?Oa/Ka:1,ca=function(h,m,w,s,v,y,E,F,O,N,R,Q,H){"undefined"===typeof H&&(H=1);E=E||0;F=F||"black";var J=15<s-m&&15<v-w?8:0.35*Math.min(s-m,v-w);h.beginPath();h.moveTo(m,w);h.save();h.fillStyle=y;h.globalAlpha=H;h.fillRect(m,w,s-m,v-w);h.globalAlpha=1;0<E&&(H=0===E%2?0:0.5,h.beginPath(),h.lineWidth=E,h.strokeStyle=
F,h.moveTo(m,w),h.rect(m-H,w-H,s-m+2*H,v-w+2*H),h.stroke());h.restore();!0===O&&(h.save(),h.beginPath(),h.moveTo(m,w),h.lineTo(m+J,w+J),h.lineTo(s-J,w+J),h.lineTo(s,w),h.closePath(),E=h.createLinearGradient((s+m)/2,w+J,(s+m)/2,w),E.addColorStop(0,y),E.addColorStop(1,"rgba(255, 255, 255, .4)"),h.fillStyle=E,h.fill(),h.restore());!0===N&&(h.save(),h.beginPath(),h.moveTo(m,v),h.lineTo(m+J,v-J),h.lineTo(s-J,v-J),h.lineTo(s,v),h.closePath(),E=h.createLinearGradient((s+m)/2,v-J,(s+m)/2,v),E.addColorStop(0,
y),E.addColorStop(1,"rgba(255, 255, 255, .4)"),h.fillStyle=E,h.fill(),h.restore());!0===R&&(h.save(),h.beginPath(),h.moveTo(m,w),h.lineTo(m+J,w+J),h.lineTo(m+J,v-J),h.lineTo(m,v),h.closePath(),E=h.createLinearGradient(m+J,(v+w)/2,m,(v+w)/2),E.addColorStop(0,y),E.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=E,h.fill(),h.restore());!0===Q&&(h.save(),h.beginPath(),h.moveTo(s,w),h.lineTo(s-J,w+J),h.lineTo(s-J,v-J),h.lineTo(s,v),E=h.createLinearGradient(s-J,(v+w)/2,s,(v+w)/2),E.addColorStop(0,
y),E.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=E,E.addColorStop(0,y),E.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=E,h.fill(),h.closePath(),h.restore())},Z=function(h){for(var m="",s=0;s<h.length;s++)m+=String.fromCharCode(Math.ceil(h.length/57/5)^h.charCodeAt(s));return m},$a=window&&window[Z("mnb`uhno")]&&window[Z("mnb`uhno")].href&&window[Z("mnb`uhno")].href.indexOf&&(-1!==window[Z("mnb`uhno")].href.indexOf(Z("b`ow`rkr/bnl"))||-1!==window[Z("mnb`uhno")].href.indexOf(Z("gdonqhy/bnl"))||
-1!==window[Z("mnb`uhno")].href.indexOf(Z("gheemd"))),gb=$a&&-1===window[Z("mnb`uhno")].href.indexOf(Z("gheemd")),hb={reset:{image:"data:image/png;base64,"},
...
"");h+=this.fontWeight?this.fontWeight+" ":"";h+=this.fontSize?this.fontSize+"px ":"";var m=this.fontFamily?this.fontFamily+"":"";!v&&m&&(m=m.split(",")[0],"'"!==m[0]&&'"'!==m[0]&&(m="'"+m+"'"));return h+=m};na(Qa,V);na(wa,V);wa.prototype.setLayout=function(){if(this.text){var h=this.dockInsidePlotArea?this.chart.plotArea:this.chart,m=h.layoutManager.getFreeSpace(),v=m.x1,y=m.y1,F=0,J=0,E=this.chart._menuButton&&this.chart.exportEnabled&&"top"===this.verticalAlign?22:0,O,H;"top"===this.verticalAlign||
...
v;J.y=y;J.angle=F;J.horizontalAlign=O;this._textBlock=J;h.layoutManager.registerSpace(H,{width:this.width+("left"===H||"right"===H?this.margin+2:0),height:this.height+("top"===H||"bottom"===H?this.margin+2:0)});this.bounds={x1:v,y1:y,x2:v+this.width,y2:y+this.height};this.ctx.textBaseline="top"}};wa.prototype.render=function(){this._textBlock&&this._textBlock.render(!0)};na(Fa,V);Fa.prototype.setLayout=wa.prototype.setLayout;Fa.prototype.render=wa.prototype.render;Ra.prototype.get=function(h,m){var s=
null;0<this.pool.length?(s=this.pool.pop(),Ja(s,h,m)):s=ra(h,m);return s};Ra.prototype.release=function(h){this.pool.push(h)};na(Ga,V);var Ma={addTheme:function(h,m){Za[h]=m},addColorSet:function(h,m){xa[h]=m},addCultureInfo:function(h,m){Ha[h]=m},formatNumber:function(h,m,s){s=s||"en";if(Ha[s])return ea(h,m||"#,##0.##",new Ga(s));throw"Unknown Culture Name";},formatDate:function(h,m,s){s=s||"en";if(Ha[s])return ya(h,m||"DD MMM YYYY",new Ga(s));throw"Unknown Culture Name";}};"undefined"!==typeof module&&
...
k=1;n=A?Math.abs(e-c):Math.abs(b-d);n=0<l.trimLength?Math.abs(n*l.trimLength/100):Math.abs(n-l.length);A?(c+=n/2,e-=n/2):(d+=n/2,b-=n/2);var n=1===Math.round(l.thickness)%2?0.5:0,p=1===Math.round(u.thickness)%2?0.5:0;a.save();a.globalAlpha=k;a.strokeStyle=u.color||f;a.lineWidth=u.thickness||2;a.setLineDash&&a.setLineDash(O(u.dashType,u.thickness));a.beginPath();A&&0<u.thickness?(a.moveTo(b-l.thickness/2,Math.round((c+e)/2)-p),a.lineTo(d+l.thickness/2,Math.round((c+e)/2)-p)):0<u.thickness&&(a.moveTo(Math.round((d+
b)/2)-p,c+l.thickness/2),a.lineTo(Math.round((d+b)/2)-p,e-l.thickness/2));a.stroke();a.strokeStyle=l.color||f;a.lineWidth=l.thickness||2;a.setLineDash&&a.setLineDash(O(l.dashType,l.thickness));a.beginPath();A&&0<l.thickness?(a.moveTo(b-n,c),a.lineTo(b-n,e),a.moveTo(d+n,c),a.lineTo(d+n,e)):0<l.thickness&&(a.moveTo(d,c+n),a.lineTo(b,c+n),a.moveTo(d,e-n),a.lineTo(b,e-n));a.stroke();a.restore()}function F(a,d){F.base.constructor.call(this,"Legend","legend",d,null,a);this.chart=a;this.canvas=a.canvas;
...
new Ga(this.options.culture);this.updateOption("animationEnabled");this.animationEnabled=this.animationEnabled&&v;this.updateOption("animationDuration");this.updateOption("rangeChanging");this.updateOption("rangeChanged");this.updateOption("exportEnabled");this.updateOption("exportFileName");this.updateOption("zoomType");this.toolbar=new Qa(this,this.options.toolbar);if(this.options.zoomEnabled||this.panEnabled){if(this._zoomButton)ga(this._zoomButton,{borderRight:this.toolbar.buttonBorderThickness+
"px solid "+this.toolbar.buttonBorderColor,backgroundColor:a.toolbar.itemBackgroundColor,color:a.toolbar.fontColor});else{var d=!1;sa(this._zoomButton=document.createElement("button"));ta(this,this._zoomButton,"pan");this._toolBar.appendChild(this._zoomButton);this._zoomButton.style.borderRight=this.toolbar.buttonBorderThickness+"px solid "+this.toolbar.buttonBorderColor;U(this._zoomButton,"touchstart",function(a){d=!0},this.allDOMEventHandlers);U(this._zoomButton,"click",function(){a.zoomEnabled?
(a.zoomEnabled=!1,a.panEnabled=!0,ta(a,a._zoomButton,"zoom")):(a.zoomEnabled=!0,a.panEnabled=!1,ta(a,a._zoomButton,"pan"));a.render()},this.allDOMEventHandlers);U(this._zoomButton,"mouseover",function(){d?d=!1:(ga(a._zoomButton,{backgroundColor:a.toolbar.itemBackgroundColorOnHover,color:a.toolbar.fontColorOnHover,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&ga(a._zoomButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},this.allDOMEventHandlers);
U(this._zoomButton,"mouseout",function(){d||(ga(a._zoomButton,{backgroundColor:a.toolbar.itemBackgroundColor,color:a.toolbar.fontColor,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&ga(a._zoomButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"}))},this.allDOMEventHandlers)}this._resetButton?ga(this._resetButton,{borderRight:this.toolbar.buttonBorderThickness+"px solid "+this.toolbar.buttonBorderColor,backgroundColor:a.toolbar.itemBackgroundColor,
color:a.toolbar.fontColor}):(d=!1,sa(this._resetButton=document.createElement("button")),ta(this,this._resetButton,"reset"),this._resetButton.style.borderRight=(this.exportEnabled?this.toolbar.buttonBorderThickness:0)+"px solid "+this.toolbar.buttonBorderColor,this._toolBar.appendChild(this._resetButton),U(this._resetButton,"touchstart",function(a){d=!0},this.allDOMEventHandlers),U(this._resetButton,"click",function(){a.toolTip.hide();a.toolTip.dispatchEvent("hidden",{chart:a,toolTip:a.toolTip},a.toolTip);
a.zoomEnabled||a.panEnabled?(a.zoomEnabled=!0,a.panEnabled=!1,ta(a,a._zoomButton,"pan"),a._defaultCursor="default",a.overlaidCanvas.style.cursor=a._defaultCursor):(a.zoomEnabled=!1,a.panEnabled=!1);if(a.sessionVariables.axisX)for(var b=0;b<a.sessionVariables.axisX.length;b++)a.sessionVariables.axisX[b].newViewportMinimum=null,a.sessionVariables.axisX[b].newViewportMaximum=null;if(a.sessionVariables.axisX2)for(b=0;b<a.sessionVariables.axisX2.length;b++)a.sessionVariables.axisX2[b].newViewportMinimum=
...
a.stockChart._rangeEventParameter,a.stockChart))},this.allDOMEventHandlers),U(this._resetButton,"mouseover",function(){d||(ga(a._resetButton,{backgroundColor:a.toolbar.itemBackgroundColorOnHover,color:a.toolbar.fontColorOnHover,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&ga(a._resetButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},this.allDOMEventHandlers),U(this._resetButton,"mouseout",function(){d||(ga(a._resetButton,{backgroundColor:a.toolbar.itemBackgroundColor,
...
m.prototype._updateSize=function(){var a;a=[this.canvas,this.overlaidCanvas,this._eventManager.ghostCanvas];var d=0,c=0;this.options.width?d=this.width:this.width=d=0<this.container.clientWidth?this.container.clientWidth:this.width;this.options.height?c=this.height:this.height=c=0<this.container.clientHeight?this.container.clientHeight:this.height;if(this.canvas.width!==d*ka||this.canvas.height!==c*ka){for(var b=0;b<a.length;b++)Ja(a[b],d,c);this.bounds={x1:0,y1:0,x2:this.width,y2:this.height,width:this.width,
height:this.height};a=!0}else a=!1;return a};m.prototype._initialize=function(){this.isNavigator=s(this.parent)||s(this.parent._defaultsKey)||"Navigator"!==this.parent._defaultsKey?!1:!0;this._animator?this._animator.cancelAllAnimations():this._animator=new ha(this);this.removeAllEventListeners();this.disableToolTip=!1;this._axes=[];this.funnelPyramidClickHandler=this.pieDoughnutClickHandler=null;this._updateOptions();this.animatedRender=v&&this.animationEnabled&&0===this.renderCount;this._updateSize();
this.clearCanvas();this.ctx.beginPath();this.axisX=[];this.axisX2=[];this.axisY=[];this.axisY2=[];this._indexLabels=[];this._dataInRenderedOrder=[];this._events=[];this._eventManager&&this._eventManager.reset();this.plotInfo={axisPlacement:null,plotTypes:[]};this.layoutManager=new Ba(0,0,this.width,this.height,this.isNavigator?0:2);this.plotArea.layoutManager&&this.plotArea.layoutManager.reset();this.data=[];this.title=null;this.subtitles=[];var a=0,d=null;if(this.options.data){for(var c=0;c<this.options.data.length;c++)if(a++,
!this.options.data[c].type||0<=m._supportedChartTypes.indexOf(this.options.data[c].type)){var b=new H(this,this.options.data[c],a-1,++this._eventManager.lastObjectId);"error"===b.type&&(b.linkedDataSeriesIndex=s(this.options.data[c].linkedDataSeriesIndex)?c-1:this.options.data[c].linkedDataSeriesIndex,0>b.linkedDataSeriesIndex||b.linkedDataSeriesIndex>=this.options.data.length||"number"!==typeof b.linkedDataSeriesIndex||"error"===this.options.data[b.linkedDataSeriesIndex].type)&&(b.linkedDataSeriesIndex=
...
"undefined"===typeof this.axisX2[0].options.gridThickness?this.axisX2[0].gridThickness=0:0<this.axisX2[0].gridThickness&&"undefined"===typeof this.axisX[0].options.gridThickness&&(this.axisX[0].gridThickness=0));c=!1;if(0<this._axes.length&&this.options.zoomEnabled&&(this.zoomEnabled||this.panEnabled))for(d=0;d<this._axes.length;d++)if(null!==this._axes[d].viewportMinimum||null!==this._axes[d].viewportMaximum){c=!0;break}c?(Ia(this._zoomButton,this._resetButton),this._toolBar.style.border=this.toolbar.buttonBorderThickness+
"px solid "+this.toolbar.buttonBorderColor,this._zoomButton.style.borderRight=this.toolbar.buttonBorderThickness+"px solid "+this.toolbar.buttonBorderColor,this._resetButton.style.borderRight=(this.exportEnabled?this.toolbar.buttonBorderThickness:0)+"px solid "+this.toolbar.buttonBorderColor):(sa(this._zoomButton,this._resetButton),this._toolBar.style.border=this.toolbar.buttonBorderThickness+"px solid transparent",this.options.zoomEnabled&&(this.zoomEnabled=!0,this.panEnabled=!1));cb(this);this._processData();
this.options.title&&(this.title=new wa(this,this.options.title),this.title.dockInsidePlotArea?a.push(this.title):this.title.setLayout());if(this.options.subtitles)for(d=0;d<this.options.subtitles.length;d++)c=new Fa(this,this.options.subtitles[d],d),this.subtitles.push(c),c.dockInsidePlotArea?a.push(c):c.setLayout();this.legend=new F(this,this.options.legend);for(d=0;d<this.data.length;d++)(this.data[d].showInLegend||"pie"===this.data[d].type||"doughnut"===this.data[d].type||"funnel"===this.data[d].type||
...
this.legend.render();if("normal"===this.plotInfo.axisPlacement||"xySwapped"===this.plotInfo.axisPlacement)E.render(this.axisX,this.axisX2,this.axisY,this.axisY2,this.plotInfo.axisPlacement);else if("none"===this.plotInfo.axisPlacement)this.preparePlotArea();else return;for(d=0;d<a.length;d++)a[d].setLayout(),a[d].render();var c=[];if(this.animatedRender){var b=ra(this.width,this.height);b.getContext("2d").drawImage(this.canvas,0,0,this.width,this.height)}fb(this);var a=this.ctx.miterLimit,e;this.ctx.miterLimit=
...
new Ba(a.x1,a.y1,a.x2,a.y2,2)};m.prototype.renderIndexLabels=function(a){var d=a||this.plotArea.ctx,c=this.plotArea,b=0,e=0,f=0,l=f=e=0,u=0,A=b=0,k=0;for(a=0;a<this._indexLabels.length;a++){var n=this._indexLabels[a],p=n.chartType.toLowerCase(),q,g,l=la("indexLabelFontColor",n.dataPoint,n.dataSeries),r=la("indexLabelFontSize",n.dataPoint,n.dataSeries),u=la("indexLabelFontFamily",n.dataPoint,n.dataSeries),A=la("indexLabelFontStyle",n.dataPoint,n.dataSeries),k=la("indexLabelFontWeight",n.dataPoint,
...
this.plotArea.height:this.plotArea.width)<<0):0,C={percent:null,total:null},B=null;if(0<=n.dataSeries.type.indexOf("stacked")||"pie"===n.dataSeries.type||"doughnut"===n.dataSeries.type)C=this.getPercentAndTotal(n.dataSeries,n.dataPoint);if(n.dataSeries.indexLabelFormatter||n.dataPoint.indexLabelFormatter)B={chart:this,dataSeries:n.dataSeries,dataPoint:n.dataPoint,index:n.indexKeyword,total:C.total,percent:C.percent};var D=n.dataPoint.indexLabelFormatter?n.dataPoint.indexLabelFormatter(B):n.dataPoint.indexLabel?
this.replaceKeywordsWithValue(n.dataPoint.indexLabel,n.dataPoint,n.dataSeries,null,n.indexKeyword):n.dataSeries.indexLabelFormatter?n.dataSeries.indexLabelFormatter(B):n.dataSeries.indexLabel?this.replaceKeywordsWithValue(n.dataSeries.indexLabel,n.dataPoint,n.dataSeries,null,n.indexKeyword):null;if(null!==D&&""!==D){var C=la("indexLabelPlacement",n.dataPoint,n.dataSeries),B=la("indexLabelOrientation",n.dataPoint,n.dataSeries),z=la("indexLabelTextAlign",n.dataPoint,n.dataSeries),w=n.direction,e=n.dataSeries.axisX,
f=n.dataSeries.axisY,y=!1,h=new ia(d,{x:0,y:0,maxWidth:q?q:0.5*this.width,maxHeight:g?5*r:1.5*r,angle:"horizontal"===B?0:-90,text:D,padding:0,backgroundColor:h,textAlign:z,fontSize:r,fontFamily:u,fontWeight:k,fontColor:l,fontStyle:A,textBaseline:"middle"});h.measureText();n.dataSeries.indexLabelMaxWidth=h.maxWidth;if("stackedarea100"===p){if(n.point.x<c.x1||n.point.x>c.x2||n.point.y<c.y1-1||n.point.y>c.y2+1)continue}else if("rangearea"===p||"rangesplinearea"===p){if(n.dataPoint.x<e.viewportMinimum||
...
e.viewportMaximum)continue;l=u=2;"horizontal"===B?(A=h.width,k=h.height):(k=h.width,A=h.height);if("normal"===this.plotInfo.axisPlacement){if(0<=p.indexOf("line")||0<=p.indexOf("area"))C="auto",u=4;else if(0<=p.indexOf("stacked"))"auto"===C&&(C="inside");else if("bubble"===p||"scatter"===p)C="inside";q=n.point.x-("horizontal"===B?A/2:A/2-r/2);"inside"!==C?(e=c.y1,f=c.y2,0<w?(g=n.point.y+("horizontal"===B?r/2:0)-k-u-b,g<e&&(g="auto"===C?Math.max(n.point.y,e)+r/2+u:e+r/2+u,y=g+k>n.point.y)):(g=n.point.y+
r/2+u+b,g>f-k&&(g="auto"===C?Math.min(n.point.y,f)+r/2-k-u:f+r/2-k,y=g<n.point.y))):(e=Math.max(n.bounds.y1,c.y1),f=Math.min(n.bounds.y2,c.y2-k+r/2),b=0<=p.indexOf("range")||"error"===p?0<w?Math.max(n.bounds.y1,c.y1)+r/2+u:Math.min(n.bounds.y2,c.y2)+r/2-k+u:(Math.max(n.bounds.y1,c.y1)+Math.min(n.bounds.y2,c.y2))/2-k/2+r/2+("horizontal"===B?u:0),0<w?(g=Math.max(n.point.y,b),g<e&&("bubble"===p||"scatter"===p)&&(g=Math.max(n.point.y-k-u,c.y1+u))):(g=Math.min(n.point.y,b),g>f-k-u&&("bubble"===p||"scatter"===
p)&&(g=Math.min(n.point.y+u,c.y2-k-u))),g=Math.min(g,f))}else 0<=p.indexOf("line")||0<=p.indexOf("area")||0<=p.indexOf("scatter")?(C="auto",l=4):0<=p.indexOf("stacked")?"auto"===C&&(C="inside"):"bubble"===p&&(C="inside"),g=n.point.y+r/2-k/2+u,"inside"!==C?(e=c.x1,f=c.x2,0>w?(q=n.point.x-("horizontal"===B?A:A-r/2)-l-b,q<e&&(q="auto"===C?Math.max(n.point.x,e)+l:e+l,y=q+A>n.point.x)):(q=n.point.x+("horizontal"===B?0:r/2)+l+b,q>f-A-l-b&&(q="auto"===C?Math.min(n.point.x,f)-("horizontal"===B?A:A/2)-l:f-
A-l,y=q<n.point.x))):(e=Math.max(n.bounds.x1,c.x1),Math.min(n.bounds.x2,c.x2),b=0<=p.indexOf("range")||"error"===p?0>w?Math.max(n.bounds.x1,c.x1)+r/2+l:Math.min(n.bounds.x2,c.x2)-A/2-l+("horizontal"===B?0:r/2):(Math.max(n.bounds.x1,c.x1)+Math.min(n.bounds.x2,c.x2))/2+("horizontal"===B?0:r/2),q=0>w?Math.max(n.point.x,b)-("horizontal"===B?A/2:0):Math.min(n.point.x,b)-A/2,q=Math.max(q,e));"vertical"===B&&(g+=k-r/2);h.x=q;h.y=g;h.render(!0);x&&("inside"!==C&&(0>p.indexOf("bar")&&("error"!==p||!n.axisSwapped)&&
n.point.x>c.x1&&n.point.x<c.x2||!y)&&(0>p.indexOf("column")&&("error"!==p||n.axisSwapped)&&n.point.y>c.y1&&n.point.y<c.y2||!y))&&(d.lineWidth=x,d.strokeStyle=t?t:"gray",d.setLineDash&&d.setLineDash(O(m,x)),d.beginPath(),d.moveTo(n.point.x,n.point.y),0<=p.indexOf("bar")||"error"===p&&n.axisSwapped?d.lineTo(q+(0<n.direction?-l:A+l)+("vertical"===B?-r/2:0),g+("vertical"===B?-k/2:k/2-r/2)-u):0<=p.indexOf("column")||"error"===p&&!n.axisSwapped?d.lineTo(q+A/2-("horizontal"===B?0:r/2),g+("vertical"===B?
(g-k<n.point.y?0:-k)+u:(g-r/2<n.point.y?k:0)-r/2)):d.lineTo(q+A/2-("horizontal"===B?0:r/2),g+("vertical"===B?g-k<n.point.y?0:-k:(g-r/2<n.point.y?k:0)-r/2)),d.stroke())}}d={source:d,dest:this.plotArea.ctx,animationCallback:L.fadeInAnimation,easingFunction:L.easing.easeInQuad,animationBase:0,startTimePercent:0.7};for(a=0;a<this._indexLabels.length;a++)n=this._indexLabels[a],h=la("indexLabelBackgroundColor",n.dataPoint,n.dataSeries),n.dataSeries.indexLabelBackgroundColor=s(h)?v?"transparent":null:h;
return d};m.prototype.renderLine=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=v?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx;c.save();var e=this.plotArea;c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();for(var f=[],l,u=0;u<a.dataSeriesIndexes.length;u++){var A=a.dataSeriesIndexes[u],k=this.data[A];c.lineWidth=k.lineThickness;var n=k.dataPoints,p="solid";if(c.setLineDash){var q=O(k.nullDataLineDashType,k.lineThickness),p=k.lineDashType,
g=O(p,k.lineThickness);c.setLineDash(g)}var r=k.id;this._eventManager.objectMap[r]={objectType:"dataSeries",dataSeriesIndex:A};r=Q(r);b.strokeStyle=r;b.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var r=k._colorSet,h=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];c.strokeStyle=r;var m=!0,t=0,x,s;c.beginPath();if(0<n.length){for(var B=!1,t=0;t<n.length;t++)if(x=n[t].x.getTime?n[t].x.getTime():n[t].x,!(x<a.axisX.dataInfo.viewPortMin||x>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||
!B)))if("number"!==typeof n[t].y)0<t&&!(k.connectNullData||B||m)&&(c.stroke(),v&&b.stroke()),B=!0;else{x=a.axisX.convertValueToPixel(x);s=a.axisY.convertValueToPixel(n[t].y);var D=k.dataPointIds[t];this._eventManager.objectMap[D]={id:D,objectType:"dataPoint",dataSeriesIndex:A,dataPointIndex:t,x1:x,y1:s};m||B?(!m&&k.connectNullData?(c.setLineDash&&(k.options.nullDataLineDashType||p===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,l.y),p=k.nullDataLineDashType,
c.setLineDash(q)),c.lineTo(x,s),v&&b.lineTo(x,s)):(c.beginPath(),c.moveTo(x,s),v&&(b.beginPath(),b.moveTo(x,s))),B=m=!1):(c.lineTo(x,s),v&&b.lineTo(x,s),0==t%500&&(c.stroke(),c.beginPath(),c.moveTo(x,s),v&&(b.stroke(),b.beginPath(),b.moveTo(x,s))));l={x:x,y:s};t<n.length-1&&(h!==(n[t].lineColor||r)||p!==(n[t].lineDashType||k.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(x,s),h=n[t].lineColor||r,c.strokeStyle=h,c.setLineDash&&(n[t].lineDashType?(p=n[t].lineDashType,c.setLineDash(O(p,k.lineThickness))):
(p=k.lineDashType,c.setLineDash(g))));if(0<n[t].markerSize||0<k.markerSize){var z=k.getMarkerProperties(t,x,s,c);f.push(z);D=Q(D);v&&f.push({x:x,y:s,ctx:b,type:z.type,size:z.size,color:D,borderColor:D,borderThickness:z.borderThickness})}(n[t].indexLabel||k.indexLabel||n[t].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"line",dataPoint:n[t],dataSeries:k,point:{x:x,y:s},direction:0>n[t].y===a.axisY.reversed?1:-1,color:r})}c.stroke();v&&b.stroke()}}W.drawMarkers(f);v&&
...
easingFunction:L.easing.linear,animationBase:0}}};m.prototype.renderStepLine=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=v?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx;c.save();var e=this.plotArea;c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();for(var f=[],l,u=0;u<a.dataSeriesIndexes.length;u++){var A=a.dataSeriesIndexes[u],k=this.data[A];c.lineWidth=k.lineThickness;var n=k.dataPoints,p="solid";if(c.setLineDash){var q=O(k.nullDataLineDashType,
k.lineThickness),p=k.lineDashType,g=O(p,k.lineThickness);c.setLineDash(g)}var r=k.id;this._eventManager.objectMap[r]={objectType:"dataSeries",dataSeriesIndex:A};r=Q(r);b.strokeStyle=r;b.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var r=k._colorSet,h=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];c.strokeStyle=r;var m=!0,t=0,x,s;c.beginPath();if(0<n.length){for(var B=!1,t=0;t<n.length;t++)if(x=n[t].getTime?n[t].x.getTime():n[t].x,!(x<a.axisX.dataInfo.viewPortMin||x>a.axisX.dataInfo.viewPortMax&&
(!k.connectNullData||!B)))if("number"!==typeof n[t].y)0<t&&!(k.connectNullData||B||m)&&(c.stroke(),v&&b.stroke()),B=!0;else{var D=s;x=a.axisX.convertValueToPixel(x);s=a.axisY.convertValueToPixel(n[t].y);var z=k.dataPointIds[t];this._eventManager.objectMap[z]={id:z,objectType:"dataPoint",dataSeriesIndex:A,dataPointIndex:t,x1:x,y1:s};m||B?(!m&&k.connectNullData?(c.setLineDash&&(k.options.nullDataLineDashType||p===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,
l.y),p=k.nullDataLineDashType,c.setLineDash(q)),c.lineTo(x,D),c.lineTo(x,s),v&&(b.lineTo(x,D),b.lineTo(x,s))):(c.beginPath(),c.moveTo(x,s),v&&(b.beginPath(),b.moveTo(x,s))),B=m=!1):(c.lineTo(x,D),v&&b.lineTo(x,D),c.lineTo(x,s),v&&b.lineTo(x,s),0==t%500&&(c.stroke(),c.beginPath(),c.moveTo(x,s),v&&(b.stroke(),b.beginPath(),b.moveTo(x,s))));l={x:x,y:s};t<n.length-1&&(h!==(n[t].lineColor||r)||p!==(n[t].lineDashType||k.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(x,s),h=n[t].lineColor||r,c.strokeStyle=
h,c.setLineDash&&(n[t].lineDashType?(p=n[t].lineDashType,c.setLineDash(O(p,k.lineThickness))):(p=k.lineDashType,c.setLineDash(g))));if(0<n[t].markerSize||0<k.markerSize)D=k.getMarkerProperties(t,x,s,c),f.push(D),z=Q(z),v&&f.push({x:x,y:s,ctx:b,type:D.type,size:D.size,color:z,borderColor:z,borderThickness:D.borderThickness});(n[t].indexLabel||k.indexLabel||n[t].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepLine",dataPoint:n[t],dataSeries:k,point:{x:x,y:s},direction:0>
...
this._eventManager.ghostCtx;b.save();var f=this.plotArea;b.beginPath();b.rect(f.x1,f.y1,f.width,f.height);b.clip();for(var l=[],u=0;u<a.dataSeriesIndexes.length;u++){var A=a.dataSeriesIndexes[u],k=this.data[A];b.lineWidth=k.lineThickness;var n=k.dataPoints,p="solid";if(b.setLineDash){var q=O(k.nullDataLineDashType,k.lineThickness),p=k.lineDashType,g=O(p,k.lineThickness);b.setLineDash(g)}var r=k.id;this._eventManager.objectMap[r]={objectType:"dataSeries",dataSeriesIndex:A};r=Q(r);e.strokeStyle=r;e.lineWidth=
...
O(p,k.lineThickness)):(p=k.lineDashType,s[s.length-1].newLineDashArray=g)));if(0<n[m].markerSize||0<k.markerSize){var D=k.getMarkerProperties(m,t,x,b);l.push(D);B=Q(B);v&&l.push({x:t,y:x,ctx:e,type:D.type,size:D.size,color:B,borderColor:B,borderThickness:D.borderThickness})}(n[m].indexLabel||k.indexLabel||n[m].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"spline",dataPoint:n[m],dataSeries:k,point:{x:t,y:x},direction:0>n[m].y===a.axisY.reversed?1:-1,color:r});x=!1}d(s)}W.drawMarkers(l);
...
a.dataSeriesIndexes[r],m=this.data[h],t=m.dataPoints;if(0<t.length){var x=5<g&&m.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<t.length;k++)if(b=t[k].x.getTime?t[k].x.getTime():t[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof t[k].y){n=a.axisX.convertValueToPixel(b);var s=n-a.plotType.plotUnits.length*g/2+a.index*g<<0,B=s+g<<0,D;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<t[k].y)u[b]=t[k].y+(u[b]?u[b]:
0),0<u[b]&&(p=a.axisY.convertValueToPixel(u[b]),D="undefined"!==typeof f[b]?f[b]:q,f[b]=p);else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=t[k].y)A[b]=t[k].y+(A[b]?A[b]:0),D=a.axisY.convertValueToPixel(A[b]),p="undefined"!==typeof l[b]?l[b]:q,l[b]=D;else if(p=a.axisY.convertValueToPixel(t[k].y),0<=t[k].y){var z="undefined"!==typeof f[b]?f[b]:0;p-=z;D=q-z;f[b]=z+(D-p)}else z=l[b]?l[b]:0,D=p+z,p=q+z,l[b]=z+(D-p);b=t[k].color?t[k].color:m._colorSet[k%m._colorSet.length];
ca(c,s,p,B,D,b,0,null,x&&0<=t[k].y,0>t[k].y&&x,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:s,y1:p,x2:B,y2:D};b=Q(b);v&&ca(this._eventManager.ghostCtx,s,p,B,D,b,0,null,!1,!1,!1,!1);(t[k].indexLabel||m.indexLabel||t[k].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedColumn",dataPoint:t[k],dataSeries:m,point:{x:n,y:0<=t[k].y?p:D},direction:0>t[k].y===a.axisY.reversed?
1:-1,bounds:{x1:s,y1:Math.min(p,D),x2:B,y2:Math.max(p,D)},color:b})}}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());
...
k>n&&(k=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,n));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&n<k)&&(n=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,k));g<k&&(g=k);g>n&&(g=n);c.save();v&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();v&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var h=
a.dataSeriesIndexes[r],m=this.data[h],t=m.dataPoints;if(0<t.length)for(var s=5<g&&m.bevelEnabled?!0:!1,k=0;k<t.length;k++)if(b=t[k].x.getTime?t[k].x.getTime():t[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof t[k].y){n=a.axisX.convertValueToPixel(b);p=0!==a.dataPointYSums[b]?100*(t[k].y/a.dataPointYSums[b]):0;var C=n-a.plotType.plotUnits.length*g/2+a.index*g<<0,B=C+g<<0,D;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&
...
typeof l[b]?l[b]:0,D=p+z,p=q+z,a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.y2-D)&&(D=e.y2),l[b]=z+(D-p);b=t[k].color?t[k].color:m._colorSet[k%m._colorSet.length];ca(c,C,p,B,D,b,0,null,s&&0<=t[k].y,0>t[k].y&&s,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:C,y1:p,x2:B,y2:D};b=Q(b);v&&ca(this._eventManager.ghostCtx,C,p,B,D,b,0,null,!1,!1,!1,!1);(t[k].indexLabel||m.indexLabel||t[k].indexLabelFormatter||m.indexLabelFormatter)&&
this._indexLabels.push({chartType:"stackedColumn100",dataPoint:t[k],dataSeries:m,point:{x:n,y:0<=t[k].y?p:D},direction:0>t[k].y===a.axisY.reversed?1:-1,bounds:{x1:C,y1:Math.min(p,D),x2:B,y2:Math.max(p,D)},color:b})}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&
...
k&&(g=k);g>p&&(g=p);c.save();v&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();v&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var h=a.dataSeriesIndexes[r],m=this.data[h],t=m.dataPoints;if(0<t.length){var s=5<g&&m.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<t.length;k++)if(b=t[k].x.getTime?t[k].x.getTime():
t[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof t[k].y){p=a.axisX.convertValueToPixel(b);var C=p-a.plotType.plotUnits.length*g/2+a.index*g<<0,B=C+g<<0,D;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<t[k].y)u[b]=t[k].y+(u[b]?u[b]:0),0<u[b]&&(D=f[b]?f[b]:q,f[b]=n=a.axisY.convertValueToPixel(u[b]));else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=t[k].y)A[b]=t[k].y+(A[b]?A[b]:0),n=l[b]?
l[b]:q,l[b]=D=a.axisY.convertValueToPixel(A[b]);else if(n=a.axisY.convertValueToPixel(t[k].y),0<=t[k].y){var z=f[b]?f[b]:0;D=q+z;n+=z;f[b]=z+(n-D)}else z=l[b]?l[b]:0,D=n-z,n=q-z,l[b]=z+(n-D);b=t[k].color?t[k].color:m._colorSet[k%m._colorSet.length];ca(c,D,C,n,B,b,0,null,s,!1,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:D,y1:C,x2:n,y2:B};b=Q(b);v&&ca(this._eventManager.ghostCtx,D,C,n,B,b,0,null,!1,!1,!1,
!1);(t[k].indexLabel||m.indexLabel||t[k].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar",dataPoint:t[k],dataSeries:m,point:{x:0<=t[k].y?n:D,y:p},direction:0>t[k].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(D,n),y1:C,x2:Math.max(D,n),y2:B},color:b})}}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&
...
"number"===typeof t[k].y){p=a.axisX.convertValueToPixel(b);var C;C=0!==a.dataPointYSums[b]?100*(t[k].y/a.dataPointYSums[b]):0;var B=p-a.plotType.plotUnits.length*g/2+a.index*g<<0,D=B+g<<0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<t[k].y){u[b]=C+(u[b]?u[b]:0);if(0>=u[b])continue;C=f[b]?f[b]:q;f[b]=n=a.axisY.convertValueToPixel(u[b])}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=t[k].y)A[b]=C+(A[b]?A[b]:0),n=l[b]?l[b]:
q,l[b]=C=a.axisY.convertValueToPixel(A[b]);else if(n=a.axisY.convertValueToPixel(C),0<=t[k].y){var z=f[b]?f[b]:0;C=q+z;n+=z;a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.x2-n)&&(n=e.x2);f[b]=z+(n-C)}else z=l[b]?l[b]:0,C=n-z,n=q-z,a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.x1-C)&&(C=e.x1),l[b]=z+(n-C);b=t[k].color?t[k].color:m._colorSet[k%m._colorSet.length];ca(c,C,B,n,D,b,0,null,s,!1,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,
dataPointIndex:k,x1:C,y1:B,x2:n,y2:D};b=Q(b);v&&ca(this._eventManager.ghostCtx,C,B,n,D,b,0,null,!1,!1,!1,!1);(t[k].indexLabel||m.indexLabel||t[k].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar100",dataPoint:t[k],dataSeries:m,point:{x:0<=t[k].y?n:C,y:p},direction:0>t[k].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(C,n),y1:B,x2:Math.max(C,n),y2:D},color:b})}}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",
...
q>a.axisY.bounds.x2?a.axisY.bounds.x2:q}}};m.prototype.renderArea=function(a){var d,c;function b(){D&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?B=C:0>a.axisY.viewportMaximum?B=u.y1:0<a.axisY.viewportMinimum&&(B=C),f.lineTo(m,B),f.lineTo(D.x,B),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,v&&(l.lineTo(m,B),l.lineTo(D.x,B),l.closePath(),l.fill()),f.beginPath(),f.moveTo(m,t),l.beginPath(),l.moveTo(m,t),D={x:m,y:t})}
...
A=Q(A);l.fillStyle=A;A=[];d=!0;var h=0,m,t,s,C=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),B,D=null;if(0<r.length){var z=g._colorSet[h%g._colorSet.length],w=g.lineColor=g.options.lineColor||z,y=w;f.fillStyle=z;f.strokeStyle=w;f.lineWidth=g.lineThickness;c="solid";if(f.setLineDash){var K=O(g.nullDataLineDashType,g.lineThickness);c=g.lineDashType;var aa=O(c,g.lineThickness);f.setLineDash(aa)}for(var ja=!0;h<r.length;h++)if(s=r[h].x.getTime?r[h].x.getTime():r[h].x,!(s<
...
x1:m,y1:t};0!==r[h].markerSize&&(0<r[h].markerSize||0<g.markerSize)&&(s=g.getMarkerProperties(h,m,t,f),A.push(s),Y=Q(Y),v&&A.push({x:m,y:t,ctx:l,type:s.type,size:s.size,color:Y,borderColor:Y,borderThickness:s.borderThickness}));(r[h].indexLabel||g.indexLabel||r[h].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"area",dataPoint:r[h],dataSeries:g,point:{x:m,y:t},direction:0>r[h].y===a.axisY.reversed?1:-1,color:z})}b();W.drawMarkers(A)}}v&&(e.drawImage(this._preRenderCanvas,
...
u.y1,u.width,u.height);b.clip();v&&(e.beginPath(),e.rect(u.x1,u.y1,u.width,u.height),e.clip());for(var A=0;A<a.dataSeriesIndexes.length;A++){var k=a.dataSeriesIndexes[A],n=this.data[k],p=n.dataPoints,l=n.id;this._eventManager.objectMap[l]={objectType:"dataSeries",dataSeriesIndex:k};l=Q(l);e.fillStyle=l;var l=[],q=0,g,r,h=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),m,t=null,s=[];if(0<p.length){var C=n._colorSet[q%n._colorSet.length],B=n.lineColor=n.options.lineColor||
C,D=B;b.fillStyle=C;b.strokeStyle=B;b.lineWidth=n.lineThickness;var z="solid";if(b.setLineDash){var y=O(n.nullDataLineDashType,n.lineThickness),z=n.lineDashType,E=O(z,n.lineThickness);b.setLineDash(E)}for(r=!1;q<p.length;q++)if(g=p[q].x.getTime?p[q].x.getTime():p[q].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax&&(!n.connectNullData||!r)))if("number"!==typeof p[q].y)0<q&&!r&&(n.connectNullData?b.setLineDash&&(0<s.length&&(n.options.nullDataLineDashType||!p[q-1].lineDashType))&&
(s[s.length-1].newLineDashArray=y,z=n.nullDataLineDashType):(d(),s=[])),r=!0;else{g=a.axisX.convertValueToPixel(g);r=a.axisY.convertValueToPixel(p[q].y);var K=n.dataPointIds[q];this._eventManager.objectMap[K]={id:K,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:q,x1:g,y1:r};s[s.length]={x:g,y:r};q<p.length-1&&(D!==(p[q].lineColor||B)||z!==(p[q].lineDashType||n.lineDashType))&&(D=p[q].lineColor||B,s[s.length-1].newStrokeStyle=D,b.setLineDash&&(p[q].lineDashType?(z=p[q].lineDashType,s[s.length-
1].newLineDashArray=O(z,n.lineThickness)):(z=n.lineDashType,s[s.length-1].newLineDashArray=E)));if(0!==p[q].markerSize&&(0<p[q].markerSize||0<n.markerSize)){var aa=n.getMarkerProperties(q,g,r,b);l.push(aa);K=Q(K);v&&l.push({x:g,y:r,ctx:e,type:aa.type,size:aa.size,color:K,borderColor:K,borderThickness:aa.borderThickness})}(p[q].indexLabel||n.indexLabel||p[q].indexLabelFormatter||n.indexLabelFormatter)&&this._indexLabels.push({chartType:"splineArea",dataPoint:p[q],dataSeries:n,point:{x:g,y:r},direction:0>
p[q].y===a.axisY.reversed?1:-1,color:C});r=!1}d();W.drawMarkers(l)}}v&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(u.x1,u.y1,u.width,u.height),this._eventManager.ghostCtx.restore());
b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:L.xClipAnimation,easingFunction:L.easing.linear,animationBase:0}}};m.prototype.renderStepArea=function(a){var d,c;function b(){D&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?B=C:0>a.axisY.viewportMaximum?B=u.y1:0<a.axisY.viewportMinimum&&(B=C),f.lineTo(m,B),f.lineTo(D.x,B),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,v&&(l.lineTo(m,B),l.lineTo(D.x,
B),l.closePath(),l.fill()),f.beginPath(),f.moveTo(m,t),l.beginPath(),l.moveTo(m,t),D={x:m,y:t})}var e=a.targetCanvasCtx||this.plotArea.ctx,f=v?this._preRenderCtx:e;if(!(0>=a.dataSeriesIndexes.length)){var l=this._eventManager.ghostCtx,u=a.axisY.lineCoordinates,A=[],k=this.plotArea,n;f.save();v&&l.save();f.beginPath();f.rect(k.x1,k.y1,k.width,k.height);f.clip();v&&(l.beginPath(),l.rect(k.x1,k.y1,k.width,k.height),l.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=a.dataSeriesIndexes[p],
g=this.data[q],r=g.dataPoints,A=g.id;this._eventManager.objectMap[A]={objectType:"dataSeries",dataSeriesIndex:q};A=Q(A);l.fillStyle=A;A=[];d=!0;var h=0,m,t,s,C=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),B,D=null;c=!1;if(0<r.length){var z=g._colorSet[h%g._colorSet.length],w=g.lineColor=g.options.lineColor||z,y=w;f.fillStyle=z;f.strokeStyle=w;f.lineWidth=g.lineThickness;var K="solid";if(f.setLineDash){var aa=O(g.nullDataLineDashType,g.lineThickness),K=g.lineDashType,
...
g.lineThickness))):(K=g.lineDashType,f.setLineDash(E)))),s=g.dataPointIds[h],this._eventManager.objectMap[s]={id:s,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:h,x1:m,y1:t},0!==r[h].markerSize&&(0<r[h].markerSize||0<g.markerSize)&&(Y=g.getMarkerProperties(h,m,t,f),A.push(Y),s=Q(s),v&&A.push({x:m,y:t,ctx:l,type:Y.type,size:Y.size,color:s,borderColor:s,borderThickness:Y.borderThickness})),(r[h].indexLabel||g.indexLabel||r[h].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepArea",
dataPoint:r[h],dataSeries:g,point:{x:m,y:t},direction:0>r[h].y===a.axisY.reversed?1:-1,color:z}))}b();W.drawMarkers(A)}}v&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&f.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&f.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.clearRect(k.x1,
k.y1,k.width,k.height),this._eventManager.ghostCtx.restore());f.restore();return{source:e,dest:this.plotArea.ctx,animationCallback:L.xClipAnimation,easingFunction:L.easing.linear,animationBase:0}}};m.prototype.renderStackedArea=function(a){function d(){if(!(1>k.length)){for(0<z.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);v&&s.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=z.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();v&&(s.closePath(),s.fill(),s.beginPath());k=[]}}var c=
a.targetCanvasCtx||this.plotArea.ctx,b=v?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=[],u=this.plotArea,h=[],k=[],n=[],p=[],q=0,g,r,m=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),s=this._eventManager.ghostCtx,t,x,C;v&&s.beginPath();b.save();v&&s.save();b.beginPath();b.rect(u.x1,u.y1,u.width,u.height);b.clip();v&&(s.beginPath(),s.rect(u.x1,u.y1,u.width,u.height),s.clip());for(var e=[],B=0;B<a.dataSeriesIndexes.length;B++){var D=a.dataSeriesIndexes[B],
z=this.data[D],w=z.dataPoints;z.dataPointIndexes=[];for(q=0;q<w.length;q++)D=w[q].x.getTime?w[q].x.getTime():w[q].x,z.dataPointIndexes[D]=q,e[D]||(n.push(D),e[D]=!0);n.sort(Na)}for(B=0;B<a.dataSeriesIndexes.length;B++){D=a.dataSeriesIndexes[B];z=this.data[D];w=z.dataPoints;x=!0;k=[];q=z.id;this._eventManager.objectMap[q]={objectType:"dataSeries",dataSeriesIndex:D};q=Q(q);s.fillStyle=q;if(0<n.length){var e=z._colorSet[0],y=z.lineColor=z.options.lineColor||e,K=y;b.fillStyle=e;b.strokeStyle=y;b.lineWidth=
z.lineThickness;C="solid";if(b.setLineDash){var aa=O(z.nullDataLineDashType,z.lineThickness);C=z.lineDashType;var E=O(C,z.lineThickness);b.setLineDash(E)}for(var Y=!0,q=0;q<n.length;q++){var f=n[q],fa=null,fa=0<=z.dataPointIndexes[f]?w[z.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!z.connectNullData||!Y)))if("number"!==typeof fa.y)z.connectNullData||(Y||x)||d(),Y=!0;else{g=a.axisX.convertValueToPixel(f);var ma=h[f]?h[f]:0;if(a.axisY.logarithmic||
a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[f]=fa.y+(p[f]?p[f]:0);if(0>=p[f]&&a.axisY.logarithmic)continue;r=a.axisY.convertValueToPixel(p[f])}else r=a.axisY.convertValueToPixel(fa.y),r-=ma;k.push({x:g,y:m-ma});h[f]=m-r;x||Y?(!x&&z.connectNullData?(b.setLineDash&&(z.options.nullDataLineDashType||C===z.lineDashType&&z.lineDashType!==z.nullDataLineDashType)&&(x=k.pop(),C=k[k.length-1],d(),b.moveTo(t.x,t.y),k.push(C),k.push(x),C=z.nullDataLineDashType,b.setLineDash(aa)),b.lineTo(g,
r),v&&s.lineTo(g,r)):(b.beginPath(),b.moveTo(g,r),v&&(s.beginPath(),s.moveTo(g,r))),Y=x=!1):(b.lineTo(g,r),v&&s.lineTo(g,r),0==q%250&&(d(),b.moveTo(g,r),v&&s.moveTo(g,r),k.push({x:g,y:m-ma})));t={x:g,y:r};q<w.length-1&&(K!==(w[q].lineColor||y)||C!==(w[q].lineDashType||z.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,r),k.push({x:g,y:m-ma}),K=w[q].lineColor||y,b.strokeStyle=K,b.setLineDash&&(w[q].lineDashType?(C=w[q].lineDashType,b.setLineDash(O(C,z.lineThickness))):(C=z.lineDashType,b.setLineDash(E))));
if(0<=z.dataPointIndexes[f]){var F=z.dataPointIds[z.dataPointIndexes[f]];this._eventManager.objectMap[F]={id:F,objectType:"dataPoint",dataSeriesIndex:D,dataPointIndex:z.dataPointIndexes[f],x1:g,y1:r}}0<=z.dataPointIndexes[f]&&0!==fa.markerSize&&(0<fa.markerSize||0<z.markerSize)&&(ma=z.getMarkerProperties(z.dataPointIndexes[f],g,r,b),l.push(ma),f=Q(F),v&&l.push({x:g,y:r,ctx:s,type:ma.type,size:ma.size,color:f,borderColor:f,borderThickness:ma.borderThickness}));(fa.indexLabel||z.indexLabel||fa.indexLabelFormatter||
z.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea",dataPoint:fa,dataSeries:z,point:{x:g,y:r},direction:0>w[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,r);v&&s.moveTo(g,r)}delete z.dataPointIndexes}W.drawMarkers(l);v&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),
this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(u.x1,u.y1,u.width,u.height),s.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:L.xClipAnimation,easingFunction:L.easing.linear,animationBase:0}}};m.prototype.renderStackedArea100=function(a){function d(){for(0<z.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);v&&C.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=z.fillOpacity;b.fill();
b.globalAlpha=1;b.beginPath();v&&(C.closePath(),C.fill(),C.beginPath());k=[]}var c=a.targetCanvasCtx||this.plotArea.ctx,b=v?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=this.plotArea,u=[],h=[],k=[],n=[],p=[],q=0,g,r,m,s,t,x=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),C=this._eventManager.ghostCtx;b.save();v&&C.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();v&&(C.beginPath(),C.rect(l.x1,l.y1,l.width,l.height),C.clip());
for(var e=[],B=0;B<a.dataSeriesIndexes.length;B++){var w=a.dataSeriesIndexes[B],z=this.data[w],y=z.dataPoints;z.dataPointIndexes=[];for(q=0;q<y.length;q++)w=y[q].x.getTime?y[q].x.getTime():y[q].x,z.dataPointIndexes[w]=q,e[w]||(n.push(w),e[w]=!0);n.sort(Na)}for(B=0;B<a.dataSeriesIndexes.length;B++){w=a.dataSeriesIndexes[B];z=this.data[w];y=z.dataPoints;s=!0;e=z.id;this._eventManager.objectMap[e]={objectType:"dataSeries",dataSeriesIndex:w};e=Q(e);C.fillStyle=e;k=[];if(0<n.length){var e=z._colorSet[q%
z._colorSet.length],E=z.lineColor=z.options.lineColor||e,K=E;b.fillStyle=e;b.strokeStyle=E;b.lineWidth=z.lineThickness;t="solid";if(b.setLineDash){var aa=O(z.nullDataLineDashType,z.lineThickness);t=z.lineDashType;var F=O(t,z.lineThickness);b.setLineDash(F)}for(var Y=!0,q=0;q<n.length;q++){var f=n[q],fa=null,fa=0<=z.dataPointIndexes[f]?y[z.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!z.connectNullData||!Y)))if("number"!==typeof fa.y)z.connectNullData||
...
z.lineDashType!==z.nullDataLineDashType)&&(s=k.pop(),t=k[k.length-1],d(),b.moveTo(m.x,m.y),k.push(t),k.push(s),t=z.nullDataLineDashType,b.setLineDash(aa)),b.lineTo(g,r),v&&C.lineTo(g,r)):(b.beginPath(),b.moveTo(g,r),v&&(C.beginPath(),C.moveTo(g,r))),Y=s=!1):(b.lineTo(g,r),v&&C.lineTo(g,r),0==q%250&&(d(),b.moveTo(g,r),v&&C.moveTo(g,r),k.push({x:g,y:x-ba})));m={x:g,y:r};q<y.length-1&&(K!==(y[q].lineColor||E)||t!==(y[q].lineDashType||z.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,r),k.push({x:g,y:x-
ba}),K=y[q].lineColor||E,b.strokeStyle=K,b.setLineDash&&(y[q].lineDashType?(t=y[q].lineDashType,b.setLineDash(O(t,z.lineThickness))):(t=z.lineDashType,b.setLineDash(F))));if(0<=z.dataPointIndexes[f]){var G=z.dataPointIds[z.dataPointIndexes[f]];this._eventManager.objectMap[G]={id:G,objectType:"dataPoint",dataSeriesIndex:w,dataPointIndex:z.dataPointIndexes[f],x1:g,y1:r}}0<=z.dataPointIndexes[f]&&0!==fa.markerSize&&(0<fa.markerSize||0<z.markerSize)&&(ba=z.getMarkerProperties(q,g,r,b),u.push(ba),f=Q(G),
v&&u.push({x:g,y:r,ctx:C,type:ba.type,size:ba.size,color:f,borderColor:f,borderThickness:ba.borderThickness}));(fa.indexLabel||z.indexLabel||fa.indexLabelFormatter||z.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea100",dataPoint:fa,dataSeries:z,point:{x:g,y:r},direction:0>y[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,r);v&&C.moveTo(g,r)}delete z.dataPointIndexes}W.drawMarkers(u);v&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation=
...
e&&(r=e);r>f&&(r=f);c.save();v&&b.save();c.beginPath();c.rect(l.x1,l.y1,l.width,l.height);c.clip();v&&(b.beginPath(),b.rect(l.x1,l.y1,l.width,l.height),b.clip());for(var m=0;m<a.dataSeriesIndexes.length;m++){var w=a.dataSeriesIndexes[m],t=this.data[w],x=t.dataPoints;if(0<x.length)for(var C=5<r&&t.bevelEnabled?!0:!1,u=0;u<x.length;u++)if(x[u].getTime?g=x[u].x.getTime():g=x[u].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!s(x[u].y)&&x[u].y.length&&"number"===typeof x[u].y[0]&&
"number"===typeof x[u].y[1]&&"number"===typeof x[u].y[2]&&"number"===typeof x[u].y[3]){h=a.axisX.convertValueToPixel(g);k=a.axisY.convertValueToPixel(x[u].y[0]);n=a.axisY.convertValueToPixel(x[u].y[1]);p=a.axisY.convertValueToPixel(x[u].y[2]);q=a.axisY.convertValueToPixel(x[u].y[3]);var B=h-r/2<<0,D=B+r<<0,f=t.options.fallingColor?t.fallingColor:t._colorSet[0],e=x[u].color?x[u].color:t._colorSet[0],z=Math.round(Math.max(1,0.15*r)),y=0===z%2?0:0.5,E=t.dataPointIds[u];this._eventManager.objectMap[E]=
{id:E,objectType:"dataPoint",dataSeriesIndex:w,dataPointIndex:u,x1:B,y1:k,x2:D,y2:n,x3:h,y3:p,x4:h,y4:q,borderThickness:z,color:e};c.strokeStyle=e;c.beginPath();c.lineWidth=z;b.lineWidth=Math.max(z,4);"candlestick"===t.type?(c.moveTo(h-y,n),c.lineTo(h-y,Math.min(k,q)),c.stroke(),c.moveTo(h-y,Math.max(k,q)),c.lineTo(h-y,p),c.stroke(),ca(c,B,Math.min(k,q),D,Math.max(k,q),x[u].y[0]<=x[u].y[3]?t.risingColor:f,z,e,C,C,!1,!1,t.fillOpacity),v&&(e=Q(E),b.strokeStyle=e,b.moveTo(h-y,n),b.lineTo(h-y,Math.min(k,
q)),b.stroke(),b.moveTo(h-y,Math.max(k,q)),b.lineTo(h-y,p),b.stroke(),ca(b,B,Math.min(k,q),D,Math.max(k,q),e,0,null,!1,!1,!1,!1))):"ohlc"===t.type&&(c.moveTo(h-y,n),c.lineTo(h-y,p),c.stroke(),c.beginPath(),c.moveTo(h,k),c.lineTo(B,k),c.stroke(),c.beginPath(),c.moveTo(h,q),c.lineTo(D,q),c.stroke(),v&&(e=Q(E),b.strokeStyle=e,b.moveTo(h-y,n),b.lineTo(h-y,p),b.stroke(),b.beginPath(),b.moveTo(h,k),b.lineTo(B,k),b.stroke(),b.beginPath(),b.moveTo(h,q),b.lineTo(D,q),b.stroke()));(x[u].indexLabel||t.indexLabel||
x[u].indexLabelFormatter||t.indexLabelFormatter)&&this._indexLabels.push({chartType:t.type,dataPoint:x[u],dataSeries:t,point:{x:B+(D-B)/2,y:a.axisY.reversed?p:n},direction:1,bounds:{x1:B,y1:Math.min(n,p),x2:D,y2:Math.max(n,p)},color:e})}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),
...
l&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,l));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&l<e)&&(l=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));r<e&&(r=e);r>l&&(r=l);c.save();v&&b.save();c.beginPath();c.rect(f.x1,f.y1,f.width,f.height);c.clip();v&&(b.beginPath(),b.rect(f.x1,f.y1,f.width,f.height),b.clip());for(var m=!1,m=!!a.axisY.reversed,w=0;w<a.dataSeriesIndexes.length;w++){var t=a.dataSeriesIndexes[w],x=this.data[t],C=x.dataPoints;
if(0<C.length)for(var B=5<r&&x.bevelEnabled?!0:!1,l=0;l<C.length;l++)if(C[l].getTime?g=C[l].x.getTime():g=C[l].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!s(C[l].y)&&C[l].y.length&&"number"===typeof C[l].y[0]&&"number"===typeof C[l].y[1]&&"number"===typeof C[l].y[2]&&"number"===typeof C[l].y[3]&&"number"===typeof C[l].y[4]&&5===C[l].y.length){u=a.axisX.convertValueToPixel(g);h=a.axisY.convertValueToPixel(C[l].y[0]);k=a.axisY.convertValueToPixel(C[l].y[1]);n=a.axisY.convertValueToPixel(C[l].y[2]);
p=a.axisY.convertValueToPixel(C[l].y[3]);q=a.axisY.convertValueToPixel(C[l].y[4]);var D=u-r/2<<0,z=u+r/2<<0,e=C[l].color?C[l].color:x._colorSet[0],y=Math.round(Math.max(1,0.15*r)),E=0===y%2?0:0.5,K=C[l].whiskerColor?C[l].whiskerColor:C[l].color?x.whiskerColor?x.whiskerColor:C[l].color:x.whiskerColor?x.whiskerColor:e,aa="number"===typeof C[l].whiskerThickness?C[l].whiskerThickness:"number"===typeof x.options.whiskerThickness?x.whiskerThickness:y,F=C[l].whiskerDashType?C[l].whiskerDashType:x.whiskerDashType,
Y=s(C[l].whiskerLength)?s(x.options.whiskerLength)?r:x.whiskerLength:C[l].whiskerLength,Y="number"===typeof Y?0>=Y?0:Y>=r?r:Y:"string"===typeof Y?parseInt(Y)*r/100>r?r:parseInt(Y)*r/100:r,fa=1===Math.round(aa)%2?0.5:0,ma=C[l].stemColor?C[l].stemColor:C[l].color?x.stemColor?x.stemColor:C[l].color:x.stemColor?x.stemColor:e,ba="number"===typeof C[l].stemThickness?C[l].stemThickness:"number"===typeof x.options.stemThickness?x.stemThickness:y,G=1===Math.round(ba)%2?0.5:0,J=C[l].stemDashType?C[l].stemDashType:
x.stemDashType,H=C[l].lineColor?C[l].lineColor:C[l].color?x.lineColor?x.lineColor:C[l].color:x.lineColor?x.lineColor:e,N="number"===typeof C[l].lineThickness?C[l].lineThickness:"number"===typeof x.options.lineThickness?x.lineThickness:y,R=C[l].lineDashType?C[l].lineDashType:x.lineDashType,M=1===Math.round(N)%2?0.5:0,U=x.upperBoxColor,va=x.lowerBoxColor,qa=s(x.options.fillOpacity)?1:x.fillOpacity,P=x.dataPointIds[l];this._eventManager.objectMap[P]={id:P,objectType:"dataPoint",dataSeriesIndex:t,dataPointIndex:l,
x1:D,y1:h,x2:z,y2:k,x3:u,y3:n,x4:u,y4:p,y5:q,borderThickness:y,color:e,stemThickness:ba,stemColor:ma,whiskerThickness:aa,whiskerLength:Y,whiskerColor:K,lineThickness:N,lineColor:H};c.save();0<ba&&(c.beginPath(),c.strokeStyle=ma,c.lineWidth=ba,c.setLineDash&&c.setLineDash(O(J,ba)),c.moveTo(u-G,k),c.lineTo(u-G,h),c.stroke(),c.moveTo(u-G,p),c.lineTo(u-G,n),c.stroke());c.restore();b.lineWidth=Math.max(y,4);c.beginPath();ca(c,D,Math.min(q,k),z,Math.max(k,q),va,0,e,m?B:!1,m?!1:B,!1,!1,qa);c.beginPath();
ca(c,D,Math.min(n,q),z,Math.max(q,n),U,0,e,m?!1:B,m?B:!1,!1,!1,qa);c.beginPath();c.lineWidth=y;c.strokeStyle=e;c.rect(D-E,Math.min(k,n)-E,z-D+2*E,Math.max(k,n)-Math.min(k,n)+2*E);c.stroke();c.save();0<N&&(c.beginPath(),c.globalAlpha=1,c.setLineDash&&c.setLineDash(O(R,N)),c.strokeStyle=H,c.lineWidth=N,c.moveTo(D,q-M),c.lineTo(z,q-M),c.stroke());c.restore();c.save();0<aa&&(c.beginPath(),c.setLineDash&&c.setLineDash(O(F,aa)),c.strokeStyle=K,c.lineWidth=aa,c.moveTo(u-Y/2<<0,p-fa),c.lineTo(u+Y/2<<0,p-
fa),c.stroke(),c.moveTo(u-Y/2<<0,h+fa),c.lineTo(u+Y/2<<0,h+fa),c.stroke());c.restore();v&&(e=Q(P),b.strokeStyle=e,b.lineWidth=ba,0<ba&&(b.moveTo(u-E-G,k),b.lineTo(u-E-G,Math.max(h,p)),b.stroke(),b.moveTo(u-E-G,Math.min(h,p)),b.lineTo(u-E-G,n),b.stroke()),ca(b,D,Math.max(k,n),z,Math.min(k,n),e,0,null,!1,!1,!1,!1),0<aa&&(b.beginPath(),b.lineWidth=aa,b.moveTo(u+Y/2,p-fa),b.lineTo(u-Y/2,p-fa),b.stroke(),b.moveTo(u+Y/2,h+fa),b.lineTo(u-Y/2,h+fa),b.stroke()));(C[l].indexLabel||x.indexLabel||C[l].indexLabelFormatter||
x.indexLabelFormatter)&&this._indexLabels.push({chartType:x.type,dataPoint:C[l],dataSeries:x,point:{x:D+(z-D)/2,y:a.axisY.reversed?h:p},direction:1,bounds:{x1:D,y1:Math.min(h,p),x2:z,y2:Math.max(h,p)},color:e})}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
...
l.y1,l.width,l.height),this._eventManager.ghostCtx.clip());for(var w=0,t=0;t<this.data.length;t++)!this.data[t].type.match(/(bar|column)/ig)||!this.data[t].visible||this.data[t].type.match(/(stacked)/ig)&&w||w++;for(var x=0;x<a.dataSeriesIndexes.length;x++){var C=a.dataSeriesIndexes[x],B=this.data[C],D=B.dataPoints,z=s(B._linkedSeries)?!1:B._linkedSeries.type.match(/(bar|column)/ig)&&B._linkedSeries.visible?!0:!1,E=0;if(z)for(e=B._linkedSeries.id,t=0;t<e;t++)!this.data[t].type.match(/(bar|column)/ig)||
!this.data[t].visible||this.data[t].type.match(/(stacked)/ig)&&E||(this.data[t].type.match(/(range)/ig)&&(f=!0),E++);e=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;u=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:b?Math.min(0.15*this.height,0.9*(this.plotArea.height/(z?w:1)))<<0:0.3*this.width;f&&(u=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:
b?Math.min(0.15*this.height,0.9*(this.plotArea.height/(z?w:1)))<<0:0.03*this.width);t=this.options.dataPointWidth?this.dataPointWidth:0.9*((b?l.height:l.width)*(a.axisX.logarithmic?Math.log(m)/Math.log(a.axisX.range):Math.abs(m)/Math.abs(a.axisX.range))/(z?w:1))<<0;this.dataPointMaxWidth&&e>u&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,u));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&u<e)&&(u=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));t<e&&
(t=e);t>u&&(t=u);if(0<D.length)for(var F=B._colorSet,u=0;u<D.length;u++){var e=B.lineColor=B.options.color?B.options.color:F[0],K={color:D[u].whiskerColor?D[u].whiskerColor:D[u].color?B.whiskerColor?B.whiskerColor:D[u].color:B.whiskerColor?B.whiskerColor:e,thickness:s(D[u].whiskerThickness)?B.whiskerThickness:D[u].whiskerThickness,dashType:D[u].whiskerDashType?D[u].whiskerDashType:B.whiskerDashType,length:s(D[u].whiskerLength)?s(B.options.whiskerLength)?t:B.options.whiskerLength:D[u].whiskerLength,
trimLength:s(D[u].whiskerLength)?s(B.options.whiskerLength)?50:0:0};K.length="number"===typeof K.length?0>=K.length?0:K.length>=t?t:K.length:"string"===typeof K.length?parseInt(K.length)*t/100>t?t:parseInt(K.length)*t/100>t:t;K.thickness="number"===typeof K.thickness?0>K.thickness?0:Math.round(K.thickness):2;var aa={color:D[u].stemColor?D[u].stemColor:D[u].color?B.stemColor?B.stemColor:D[u].color:B.stemColor?B.stemColor:e,thickness:D[u].stemThickness?D[u].stemThickness:B.stemThickness,dashType:D[u].stemDashType?
D[u].stemDashType:B.stemDashType};aa.thickness="number"===typeof aa.thickness?0>aa.thickness?0:Math.round(aa.thickness):2;D[u].getTime?r=D[u].x.getTime():r=D[u].x;if(!(r<a.axisX.dataInfo.viewPortMin||r>a.axisX.dataInfo.viewPortMax)&&!s(D[u].y)&&D[u].y.length&&"number"===typeof D[u].y[0]&&"number"===typeof D[u].y[1]){var ja=a.axisX.convertValueToPixel(r);b?k=ja:h=ja;ja=a.axisY.convertValueToPixel(D[u].y[0]);b?n=ja:q=ja;ja=a.axisY.convertValueToPixel(D[u].y[1]);b?p=ja:g=ja;b?(q=a.axisX.reversed?k+(z?
w:1)*t/2-(z?E-1:0)*t<<0:k-(z?w:1)*t/2+(z?E-1:0)*t<<0,g=a.axisX.reversed?q-t<<0:q+t<<0):(n=a.axisX.reversed?h+(z?w:1)*t/2-(z?E-1:0)*t<<0:h-(z?w:1)*t/2+(z?E-1:0)*t<<0,p=a.axisX.reversed?n-t<<0:n+t<<0);!b&&q>g&&(ja=q,q=g,g=ja);b&&n>p&&(ja=n,n=p,p=ja);ja=B.dataPointIds[u];this._eventManager.objectMap[ja]={id:ja,objectType:"dataPoint",dataSeriesIndex:C,dataPointIndex:u,x1:Math.min(n,p),y1:Math.min(q,g),x2:Math.max(p,n),y2:Math.max(g,q),isXYSwapped:b,stemProperties:aa,whiskerProperties:K};y(c,Math.min(n,
p),Math.min(q,g),Math.max(p,n),Math.max(g,q),e,K,aa,b);v&&y(this._eventManager.ghostCtx,n,q,p,g,e,K,aa,b);if(D[u].indexLabel||B.indexLabel||D[u].indexLabelFormatter||B.indexLabelFormatter)this._indexLabels.push({chartType:"error",dataPoint:D[u],dataSeries:B,indexKeyword:0,point:{x:b?D[u].y[1]>=D[u].y[0]?n:p:n+(p-n)/2,y:b?q+(g-q)/2:D[u].y[1]>=D[u].y[0]?g:q},direction:D[u].y[1]>=D[u].y[0]?-1:1,bounds:{x1:b?Math.min(n,p):n,y1:b?q:Math.min(q,g),x2:b?Math.max(n,p):p,y2:b?g:Math.max(q,g)},color:e,axisSwapped:b}),
this._indexLabels.push({chartType:"error",dataPoint:D[u],dataSeries:B,indexKeyword:1,point:{x:b?D[u].y[1]>=D[u].y[0]?p:n:n+(p-n)/2,y:b?q+(g-q)/2:D[u].y[1]>=D[u].y[0]?q:g},direction:D[u].y[1]>=D[u].y[0]?1:-1,bounds:{x1:b?Math.min(n,p):n,y1:b?q:Math.min(q,g),x2:b?Math.max(n,p):p,y2:b?g:Math.max(q,g)},color:e,axisSwapped:b})}}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),
...
for(var u=0;u<a.dataSeriesIndexes.length;u++){var h=[],k=a.dataSeriesIndexes[u],n=this.data[k],p=n.dataPoints,f=n.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:k};f=Q(f);e.fillStyle=f;var f=[],q=!0,g=0,r,m,s,t,x=null;if(0<p.length){var C=n._colorSet[g%n._colorSet.length],w=n.lineColor=n.options.lineColor||C,D=w;b.fillStyle=C;b.strokeStyle=w;b.lineWidth=n.lineThickness;var z="solid";if(b.setLineDash){var y=O(n.nullDataLineDashType,n.lineThickness),z=n.lineDashType,E=O(z,
n.lineThickness);b.setLineDash(E)}for(var K=!0;g<p.length;g++)if(t=p[g].x.getTime?p[g].x.getTime():p[g].x,!(t<a.axisX.dataInfo.viewPortMin||t>a.axisX.dataInfo.viewPortMax&&(!n.connectNullData||!K)))if(null!==p[g].y&&p[g].y.length&&"number"===typeof p[g].y[0]&&"number"===typeof p[g].y[1]){r=a.axisX.convertValueToPixel(t);m=a.axisY.convertValueToPixel(p[g].y[0]);s=a.axisY.convertValueToPixel(p[g].y[1]);q||K?(n.connectNullData&&!q?(b.setLineDash&&(n.options.nullDataLineDashType||z===n.lineDashType&&
n.lineDashType!==n.nullDataLineDashType)&&(h[h.length-1].newLineDashArray=E,z=n.nullDataLineDashType,b.setLineDash(y)),b.lineTo(r,m),v&&e.lineTo(r,m),h.push({x:r,y1:m,y2:s})):(b.beginPath(),b.moveTo(r,m),x={x:r,y:m},h=[],h.push({x:r,y1:m,y2:s}),v&&(e.beginPath(),e.moveTo(r,m))),K=q=!1):(b.lineTo(r,m),h.push({x:r,y1:m,y2:s}),v&&e.lineTo(r,m),0==g%250&&d());t=n.dataPointIds[g];this._eventManager.objectMap[t]={id:t,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:g,x1:r,y1:m,y2:s};g<p.length-
1&&(D!==(p[g].lineColor||w)||z!==(p[g].lineDashType||n.lineDashType))&&(d(),D=p[g].lineColor||w,h[h.length-1].newStrokeStyle=D,b.strokeStyle=D,b.setLineDash&&(p[g].lineDashType?(z=p[g].lineDashType,h[h.length-1].newLineDashArray=O(z,n.lineThickness),b.setLineDash(h[h.length-1].newLineDashArray)):(z=n.lineDashType,h[h.length-1].newLineDashArray=E,b.setLineDash(E))));if(0!==p[g].markerSize&&(0<p[g].markerSize||0<n.markerSize)){var aa=n.getMarkerProperties(g,r,s,b);f.push(aa);var F=Q(t);v&&f.push({x:r,
y:s,ctx:e,type:aa.type,size:aa.size,color:F,borderColor:F,borderThickness:aa.borderThickness});aa=n.getMarkerProperties(g,r,m,b);f.push(aa);F=Q(t);v&&f.push({x:r,y:m,ctx:e,type:aa.type,size:aa.size,color:F,borderColor:F,borderThickness:aa.borderThickness})}if(p[g].indexLabel||n.indexLabel||p[g].indexLabelFormatter||n.indexLabelFormatter)this._indexLabels.push({chartType:"rangeArea",dataPoint:p[g],dataSeries:n,indexKeyword:0,point:{x:r,y:m},direction:p[g].y[0]>p[g].y[1]===a.axisY.reversed?-1:1,color:C}),
this._indexLabels.push({chartType:"rangeArea",dataPoint:p[g],dataSeries:n,indexKeyword:1,point:{x:r,y:s},direction:p[g].y[0]>p[g].y[1]===a.axisY.reversed?1:-1,color:C})}else K||q||d(),K=!0;d();W.drawMarkers(f)}}v&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
...
{objectType:"dataSeries",dataSeriesIndex:m};f=Q(f);e.fillStyle=f;var f=[],p=0,q,g,r,s=[],y=[];if(0<n.length){var t=k._colorSet[p%k._colorSet.length],x=k.lineColor=k.options.lineColor||t,C=x;b.fillStyle=t;b.lineWidth=k.lineThickness;var B="solid",D;if(b.setLineDash){var z=O(k.nullDataLineDashType,k.lineThickness),B=k.lineDashType;D=O(B,k.lineThickness)}for(g=!1;p<n.length;p++)if(q=n[p].x.getTime?n[p].x.getTime():n[p].x,!(q<a.axisX.dataInfo.viewPortMin||q>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||
!g)))if(null!==n[p].y&&n[p].y.length&&"number"===typeof n[p].y[0]&&"number"===typeof n[p].y[1]){q=a.axisX.convertValueToPixel(q);g=a.axisY.convertValueToPixel(n[p].y[0]);r=a.axisY.convertValueToPixel(n[p].y[1]);var E=k.dataPointIds[p];this._eventManager.objectMap[E]={id:E,objectType:"dataPoint",dataSeriesIndex:m,dataPointIndex:p,x1:q,y1:g,y2:r};s[s.length]={x:q,y:g};y[y.length]={x:q,y:r};p<n.length-1&&(C!==(n[p].lineColor||x)||B!==(n[p].lineDashType||k.lineDashType))&&(C=n[p].lineColor||x,s[s.length-
1].newStrokeStyle=C,b.setLineDash&&(n[p].lineDashType?(B=n[p].lineDashType,s[s.length-1].newLineDashArray=O(B,k.lineThickness)):(B=k.lineDashType,s[s.length-1].newLineDashArray=D)));if(0!==n[p].markerSize&&(0<n[p].markerSize||0<k.markerSize)){var F=k.getMarkerProperties(p,q,g,b);f.push(F);var K=Q(E);v&&f.push({x:q,y:g,ctx:e,type:F.type,size:F.size,color:K,borderColor:K,borderThickness:F.borderThickness});F=k.getMarkerProperties(p,q,r,b);f.push(F);K=Q(E);v&&f.push({x:q,y:r,ctx:e,type:F.type,size:F.size,
...
(0<s.length&&(k.options.nullDataLineDashType||!n[p-1].lineDashType))&&(s[s.length-1].newLineDashArray=z,B=k.nullDataLineDashType):(d(D,x),s=[],y=[])),g=!0;d(D,x);W.drawMarkers(f)}}v&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
...
f.indexLabel?m.replaceKeywordsWithValue(f.indexLabel,f,k,e):k.indexLabelFormatter?k.indexLabelFormatter(u):k.indexLabel?m.replaceKeywordsWithValue(k.indexLabel,f,k,e):f.label?f.label:"";m._eventManager.objectMap[l]=p;p.center={x:C.x,y:C.y};p.y=f.y;p.radius=z;p.percentInnerRadius=F;p.indexLabelText=h;p.indexLabelPlacement=k.indexLabelPlacement;p.indexLabelLineColor=f.indexLabelLineColor?f.indexLabelLineColor:k.options.indexLabelLineColor?k.options.indexLabelLineColor:f.color?f.color:k._colorSet[e%
...
15)),h.indexLabelTextBlock.y=d,h.indexLabelTextBlock.x=c,h.indexLabelAngle=Math.atan2(h.indexLabelTextBlock.y-C.y,h.indexLabelTextBlock.x-C.x))}return k}function l(){var a=m.plotArea.ctx;a.fillStyle="grey";a.strokeStyle="grey";a.font="16px Arial";a.textBaseline="middle";for(var c=a=0,d=0,l=!0,c=0;10>c&&(1>c||0<d);c++){if(k.radius||!k.radius&&"undefined"!==typeof k.innerRadius&&null!==k.innerRadius&&z-d<=E)l=!1;l&&(z-=d);d=0;if("inside"!==k.indexLabelPlacement){v=z*w;for(a=0;a<n.length;a++){var h=
g[a];h.indexLabelTextBlock.x=C.x+v*Math.cos(h.midAngle);h.indexLabelTextBlock.y=C.y+v*Math.sin(h.midAngle);h.indexLabelAngle=h.midAngle;h.radius=z;h.percentInnerRadius=F}for(var u,s,a=0;a<n.length;a++){var h=g[a],t=e(a);if(null!==t){u=g[a];s=g[t];var y=0,y=b(u,s)-r;if(0>y){for(var B=s=0,D=0;D<n.length;D++)D!==a&&g[D].hemisphere===h.hemisphere&&(g[D].indexLabelTextBlock.y<h.indexLabelTextBlock.y?s++:B++);s=y/(s+B||1)*B;var B=-1*(y-s),J=D=0;"right"===h.hemisphere?(D=f(a,s),B=-1*(y-D),J=f(t,B),+J.toFixed(x)<
+B.toFixed(x)&&+D.toFixed(x)<=+s.toFixed(x)&&f(a,-(B-J))):(D=f(t,s),B=-1*(y-D),J=f(a,B),+J.toFixed(x)<+B.toFixed(x)&&+D.toFixed(x)<=+s.toFixed(x)&&f(t,-(B-J)))}}}}else for(a=0;a<n.length;a++)h=g[a],v="pie"===k.type?0.7*z:0.8*z,t=C.x+v*Math.cos(h.midAngle),s=C.y+v*Math.sin(h.midAngle),h.indexLabelTextBlock.x=t,h.indexLabelTextBlock.y=s;for(a=0;a<n.length;a++)if(h=g[a],t=h.indexLabelTextBlock.measureText(),0!==t.height&&0!==t.width)t=t=0,"right"===h.hemisphere?(t=q.x2-(h.indexLabelTextBlock.x+h.indexLabelTextBlock.width+
...
this.data[a.dataSeriesIndexes[0]],n=k.dataPoints,p=10,q=this.plotArea,g=k.dataPointEOs,r=2,v,w=1.3,t=20/180*Math.PI,x=6,C={x:(q.x2+q.x1)/2,y:(q.y2+q.y1)/2},B=0;a=!1;for(var y=0;y<n.length;y++)B+=Math.abs(n[y].y),!a&&("undefined"!==typeof n[y].indexLabel&&null!==n[y].indexLabel&&0<n[y].indexLabel.toString().length)&&(a=!0),!a&&("undefined"!==typeof n[y].label&&null!==n[y].label&&0<n[y].label.toString().length)&&(a=!0);if(0!==B){a=a||"undefined"!==typeof k.indexLabel&&null!==k.indexLabel&&0<k.indexLabel.toString().length;
var z="inside"!==k.indexLabelPlacement&&a?0.75*Math.min(q.width,q.height)/2:0.92*Math.min(q.width,q.height)/2;k.radius&&(z=Pa(k.radius,z));var E="undefined"!==typeof k.innerRadius&&null!==k.innerRadius?Pa(k.innerRadius,z):0.7*z;k.radius=z;"doughnut"===k.type&&(k.innerRadius=E);var F=Math.min(E/z,(z-1)/z);this.pieDoughnutClickHandler=function(a){m.isAnimating||!s(a.dataSeries.explodeOnClick)&&!a.dataSeries.explodeOnClick||(a=a.dataPoint,a.exploded=a.exploded?!1:!0,1<this.dataPoints.length&&m._animator.animate(0,
...
function(a){function d(){for(var a=0,b=[],c=0;c<x.length;c++){if("undefined"===typeof x[c].y)return-1;x[c].y="number"===typeof x[c].y?x[c].y:0;a+=Math.abs(x[c].y)}if(0===a)return-1;for(c=b[0]=0;c<x.length;c++)b.push(Math.abs(x[c].y)*E/a);return b}function c(){var a=V,b=X,c=M,d=W,e,f;e=Y;f=R-ba;d=Math.abs((f-e)*(b-a+(d-c))/2);c=W-M;e=f-e;f=c*(f-R);f=Math.abs(f);f=d+f;for(var d=[],g=0,k=0;k<x.length;k++){if("undefined"===typeof x[k].y)return-1;x[k].y="number"===typeof x[k].y?x[k].y:0;g+=Math.abs(x[k].y)}if(0===
g)return-1;for(var l=d[0]=0,n=0,h,p,b=b-a,l=!1,k=0;k<x.length;k++)a=Math.abs(x[k].y)*f/g,l?h=0==Number(c.toFixed(3))?0:a/c:(p=$*$*b*b-4*Math.abs($)*a,0>p?(p=c,l=(b+p)*(e-n)/2,a-=l,h=e-n,n+=e-n,h+=0==p?0:a/p,n+=a/p,l=!0):(h=(Math.abs($)*b-Math.sqrt(p))/2,p=b-2*h/Math.abs($),n+=h,n>e&&(n-=h,p=c,l=(b+p)*(e-n)/2,a-=l,h=e-n,n+=e-n,h+=a/p,n+=a/p,l=!0),b=p)),d.push(h);return d}function b(){if(t&&x){for(var a,b,c,d,e,f,k,l,n,h,p,q,u,m,r,A=[],w=[],C={percent:null,total:null},B=null,z=0;z<x.length;z++)r=P[z],
r="undefined"!==typeof r.x5?(r.y2+r.y4)/2:(r.y2+r.y3)/2,r=g(r).x2+1,A[z]=N-r-U;r=0.5*U;for(var z=0,D=x.length-1;z<x.length||0<=D;z++,D--){b=t.reversed?x[D]:x[z];a=b.color?b.color:t.reversed?t._colorSet[(x.length-1-z)%t._colorSet.length]:t._colorSet[z%t._colorSet.length];c=b.indexLabelPlacement||t.indexLabelPlacement||"outside";m=b.indexLabelTextAlign||t.indexLabelTextAlign||"left";d=b.indexLabelBackgroundColor||t.indexLabelBackgroundColor||(v?"transparent":null);e=b.indexLabelFontColor||t.indexLabelFontColor||
...
"solid";q="undefined"!==typeof b.indexLabelWrap?b.indexLabelWrap:"undefined"!==typeof t.indexLabelWrap?t.indexLabelWrap:!0;u=t.dataPointIds[z];y._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataPointIndex:z,dataSeriesIndex:0,funnelSection:P[t.reversed?x.length-1-z:z]};"inside"===t.indexLabelPlacement&&(A[z]=z!==ca?t.reversed?P[z].x2-P[z].x1:P[z].x3-P[z].x4:P[z].x3-P[z].x6,20>A[z]&&(A[z]=z!==ca?t.reversed?P[z].x3-P[z].x4:P[z].x2-P[z].x1:P[z].x2-P[z].x1,A[z]/=2));u=b.indexLabelMaxWidth?b.indexLabelMaxWidth:
t.options.indexLabelMaxWidth?t.indexLabelMaxWidth:A[z];if(u>A[z]||0>u)u=A[z];w[z]="inside"===t.indexLabelPlacement?P[z].height:!1;C=y.getPercentAndTotal(t,b);if(t.indexLabelFormatter||b.indexLabelFormatter)B={chart:y.options,dataSeries:t,dataPoint:b,total:C.total,percent:C.percent};b=b.indexLabelFormatter?b.indexLabelFormatter(B):b.indexLabel?y.replaceKeywordsWithValue(b.indexLabel,b,t,z):t.indexLabelFormatter?t.indexLabelFormatter(B):t.indexLabel?y.replaceKeywordsWithValue(t.indexLabel,b,t,z):b.label?
b.label:"";0>=h&&(h=0);1E3>u&&1E3-u<r&&(u+=1E3-u);Q.roundRect||za(Q);c=new ia(Q,{fontSize:f,fontFamily:l,fontColor:e,fontStyle:k,fontWeight:n,horizontalAlign:c,textAlign:m,backgroundColor:d,maxWidth:u,maxHeight:!1===w[z]?q?4.28571429*f:1.5*f:w[z],text:b,padding:da});c.measureText();I.push({textBlock:c,id:t.reversed?D:z,isDirty:!1,lineColor:a,lineThickness:h,lineDashType:p,height:c.height<c.maxHeight?c.height:c.maxHeight,width:c.width<c.maxWidth?c.width:c.maxWidth})}}}function e(){var a,b,c,d,e,f=
[];e=!1;c=0;for(var g,k=N-X-U/2,k=t.options.indexLabelMaxWidth?t.indexLabelMaxWidth>k?k:t.indexLabelMaxWidth:k,l=I.length-1;0<=l;l--){g=x[I[l].id];c=I[l];d=c.textBlock;b=(a=q(l)<P.length?I[q(l)]:null)?a.textBlock:null;c=c.height;a&&d.y+c+da>b.y&&(e=!0);c=g.indexLabelMaxWidth||k;if(c>k||0>c)c=k;f.push(c)}if(e)for(l=I.length-1;0<=l;l--)a=P[l],I[l].textBlock.maxWidth=f[f.length-(l+1)],I[l].textBlock.measureText(),I[l].textBlock.x=N-k,c=I[l].textBlock.height<I[l].textBlock.maxHeight?I[l].textBlock.height:
I[l].textBlock.maxHeight,e=I[l].textBlock.width<I[l].textBlock.maxWidth?I[l].textBlock.width:I[l].textBlock.maxWidth,I[l].height=c,I[l].width=e,c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,I[l].textBlock.y=c-I[l].height/2,t.reversed?(I[l].textBlock.y+I[l].height>S+B&&(I[l].textBlock.y=S+B-I[l].height),I[l].textBlock.y<qa-B&&(I[l].textBlock.y=qa-B)):(I[l].textBlock.y<S-B&&(I[l].textBlock.y=S-B),I[l].textBlock.y+I[l].height>qa+B&&(I[l].textBlock.y=qa+B-I[l].height))}function f(){var a,b,
c,d;if("inside"!==t.indexLabelPlacement)for(var e=0;e<P.length;e++)0==I[e].textBlock.text.length?I[e].isDirty=!0:(a=P[e],c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,b=t.reversed?"undefined"!==typeof a.x5?c>va?g(c).x2+1:(a.x2+a.x3)/2+1:(a.x2+a.x3)/2+1:"undefined"!==typeof a.x5?c<va?g(c).x2+1:(a.x4+a.x3)/2+1:(a.x2+a.x3)/2+1,I[e].textBlock.x=b+U,I[e].textBlock.y=c-I[e].height/2,t.reversed?(I[e].textBlock.y+I[e].height>S+B&&(I[e].textBlock.y=S+B-I[e].height),I[e].textBlock.y<qa-B&&(I[e].textBlock.y=
qa-B)):(I[e].textBlock.y<S-B&&(I[e].textBlock.y=S-B),I[e].textBlock.y+I[e].height>qa+B&&(I[e].textBlock.y=qa+B-I[e].height)));else for(e=0;e<P.length;e++)0==I[e].textBlock.text.length?I[e].isDirty=!0:(a=P[e],b=a.height,c=I[e].height,d=I[e].width,b>=c?(b=e!=ca?(a.x4+a.x3)/2-d/2:(a.x5+a.x4)/2-d/2,c=e!=ca?(a.y1+a.y3)/2-c/2:(a.y1+a.y4)/2-c/2,I[e].textBlock.x=b,I[e].textBlock.y=c):I[e].isDirty=!0)}function l(){function a(b,c){var d;if(0>b||b>=I.length)return 0;var e,f=I[b].textBlock;if(0>c){c*=-1;e=p(b);
d=h(e,b);if(d>=c)return f.y-=c,c;if(0==b)return 0<d&&(f.y-=d),d;d+=a(e,-(c-d));0<d&&(f.y-=d);return d}e=q(b);d=h(b,e);if(d>=c)return f.y+=c,c;if(b==P.length-1)return 0<d&&(f.y+=d),d;d+=a(e,c-d);0<d&&(f.y+=d);return d}function b(){var a,d,e,f,g=0,k;f=(R-Y+2*B)/n;k=n;for(var l,h=1;h<k;h++){e=h*f;for(var u=I.length-1;0<=u;u--)!I[u].isDirty&&(I[u].textBlock.y<e&&I[u].textBlock.y+I[u].height>e)&&(l=q(u),!(l>=I.length-1)&&I[u].textBlock.y+I[u].height+da>I[l].textBlock.y&&(I[u].textBlock.y=I[u].textBlock.y+
I[u].height-e>e-I[u].textBlock.y?e+1:e-I[u].height-1))}for(l=P.length-1;0<l;l--)if(!I[l].isDirty){e=p(l);if(0>e&&(e=0,I[e].isDirty))break;if(I[l].textBlock.y<I[e].textBlock.y+I[e].height){d=d||l;f=l;for(k=0;I[f].textBlock.y<I[e].textBlock.y+I[e].height+da;){a=a||I[f].textBlock.y+I[f].height;k+=I[f].height;k+=da;f=e;if(0>=f){f=0;k+=I[f].height;break}e=p(f);if(0>e){f=0;k+=I[f].height;break}}if(f!=l){g=I[f].textBlock.y;a-=g;a=k-a;g=c(a,d,f);break}}}return g}function c(a,b,d){var e=[],f=0,g=0;for(a=Math.abs(a);d<=
...
e=a(r,-d),e<d&&(0<e&&(d-=e),e=a(q(r),d),e!=d)));r--);b()}}function h(a,b){return(b<P.length?I[b].textBlock.y:t.reversed?S+B:qa+B)-(0>a?t.reversed?qa-B:S-B:I[a].textBlock.y+I[a].height+da)}function m(a,b,c){var d,e,g,l=[],h=B,p=[];-1!==b&&(0<=Z.indexOf(b)?(e=Z.indexOf(b),Z.splice(e,1)):(Z.push(b),Z=Z.sort(function(a,b){return a-b})));if(0===Z.length)l=ga;else{e=B*(1!=Z.length||0!=Z[0]&&Z[0]!=P.length-1?2:1)/k();for(var q=0;q<P.length;q++){if(1==Z.length&&0==Z[0]){if(0===q){l.push(ga[q]);d=h;continue}}else 0===
q&&(d=-1*h);l.push(ga[q]+d);if(0<=Z.indexOf(q)||q<P.length&&0<=Z.indexOf(q+1))d+=e}}g=function(){for(var a=[],b=0;b<P.length;b++)a.push(l[b]-P[b].y1);return a}();var u={startTime:(new Date).getTime(),duration:c||500,easingFunction:function(a,b,c,d){return L.easing.easeOutQuart(a,b,c,d)},changeSection:function(a){for(var b,c,d=0;d<P.length;d++)b=g[d],c=P[d],b*=a,"undefined"===typeof p[d]&&(p[d]=0),0>p&&(p*=-1),c.y1+=b-p[d],c.y2+=b-p[d],c.y3+=b-p[d],c.y4+=b-p[d],c.y5&&(c.y5+=b-p[d],c.y6+=b-p[d]),p[d]=
b}};a._animator.animate(0,c,function(c){var d=a.plotArea.ctx||a.ctx;ha=!0;d.clearRect(C.x1,C.y1,C.x2-C.x1,C.y2-C.y1);d.fillStyle=a.backgroundColor;d.fillRect(C.x1,C.y1,C.width,C.height);u.changeSection(c,b);var e={};e.dataSeries=t;e.dataPoint=t.reversed?t.dataPoints[x.length-1-b]:t.dataPoints[b];e.index=t.reversed?x.length-1-b:b;a.toolTip.highlightObjects([e]);for(e=0;e<P.length;e++)oa(d,P[e],t.fillOpacity);w(d);K&&("inside"!==t.indexLabelPlacement?n(d):f(),r(d));1<=c&&(ha=!1)},null,L.easing.easeOutQuart)}
function k(){for(var a=0,b=0;b<P.length-1;b++)(0<=Z.indexOf(b)||0<=Z.indexOf(b+1))&&a++;return a}function n(a){for(var b,c,d,e,f=0;f<P.length;f++)e=1===I[f].lineThickness%2?0.5:0,c=((P[f].y2+P[f].y4)/2<<0)+e,b=g(c).x2-1,d=I[f].textBlock.x,e=(I[f].textBlock.y+I[f].height/2<<0)+e,I[f].isDirty||0==I[f].lineThickness||(a.strokeStyle=I[f].lineColor,a.lineWidth=I[f].lineThickness,a.setLineDash&&a.setLineDash(O(I[f].lineDashType,I[f].lineThickness)),a.beginPath(),a.moveTo(b,c),a.lineTo(d,e),a.stroke())}
function p(a){for(a-=1;-1<=a&&-1!=a&&I[a].isDirty;a--);return a}function q(a){for(a+=1;a<=P.length&&a!=P.length&&I[a].isDirty;a++);return a}function g(a){for(var b,c=0;c<x.length;c++)if(P[c].y1<a&&P[c].y4>a){b=P[c];break}return b?(a=b.y6?a>b.y6?b.x3+(b.x4-b.x3)/(b.y4-b.y3)*(a-b.y3):b.x2+(b.x3-b.x2)/(b.y3-b.y2)*(a-b.y2):b.x2+(b.x3-b.x2)/(b.y3-b.y2)*(a-b.y2),{x1:a,x2:a}):-1}function r(a){for(var b=0;b<P.length;b++)I[b].isDirty||(a&&(I[b].textBlock.ctx=a),I[b].textBlock.render(!0))}function w(a){y.plotArea.layoutManager.reset();
a.roundRect||za(a);y.title&&(y.title.dockInsidePlotArea||"center"===y.title.horizontalAlign&&"center"===y.title.verticalAlign)&&(y.title.ctx=a,y.title.render());if(y.subtitles)for(var b=0;b<y.subtitles.length;b++){var c=y.subtitles[b];if(c.dockInsidePlotArea||"center"===c.horizontalAlign&&"center"===c.verticalAlign)y.subtitles.ctx=a,c.render()}y.legend&&(y.legend.dockInsidePlotArea||"center"===y.legend.horizontalAlign&&"center"===y.legend.verticalAlign)&&(y.legend.ctx=a,y.legend.setLayout(),y.legend.render());
J.fNg&&J.fNg(y)}var y=this;if(!(0>=a.dataSeriesIndexes.length)){for(var t=this.data[a.dataSeriesIndexes[0]],x=t.dataPoints,C=this.plotArea,B=0.025*C.width,D=0.01*C.width,z=0,E=C.height-2*B,F=Math.min(C.width-2*D,2.8*C.height),K=!1,H=0;H<x.length;H++)if(!K&&("undefined"!==typeof x[H].indexLabel&&null!==x[H].indexLabel&&0<x[H].indexLabel.toString().length)&&(K=!0),!K&&("undefined"!==typeof x[H].label&&null!==x[H].label&&0<x[H].label.toString().length)&&(K=!0),!K&&"function"===typeof t.indexLabelFormatter||
"function"===typeof x[H].indexLabelFormatter)K=!0;K=K||"undefined"!==typeof t.indexLabel&&null!==t.indexLabel&&0<t.indexLabel.toString().length;"inside"!==t.indexLabelPlacement&&K||(D=(C.width-0.75*F)/2);var H=C.x1+D,N=C.x2-D,Y=C.y1+B,R=C.y2-B,Q=a.targetCanvasCtx||this.plotArea.ctx||this.ctx;if(0!=t.length&&(t.dataPoints&&t.visible)&&0!==x.length){var ba,G;a=75*F/100;var U=30*(N-a)/100;"funnel"===t.type?(ba=s(t.options.neckHeight)?0.35*E:t.neckHeight,G=s(t.options.neckWidth)?0.25*a:t.neckWidth,"string"===
typeof ba&&ba.match(/%$/)?(ba=parseInt(ba),ba=ba*E/100):ba=parseInt(ba),"string"===typeof G&&G.match(/%$/)?(G=parseInt(G),G=G*a/100):G=parseInt(G),ba>E?ba=E:0>=ba&&(ba=0),G>a?G=a-0.5:0>=G&&(G=0)):"pyramid"===t.type&&(G=ba=0,t.reversed=t.reversed?!1:!0);var D=H+a/2,V=H,X=H+a,S=t.reversed?R:Y,M=D-G/2,W=D+G/2,va=t.reversed?Y+ba:R-ba,qa=t.reversed?Y:R;a=[];var D=[],P=[],F=[],T=Y,ca,$=(va-S)/(M-V),ea=-$,H="area"===(t.valueRepresents?t.valueRepresents:"height")?c():d();if(-1!==H){if(t.reversed)for(F.push(T),
G=H.length-1;0<G;G--)T+=H[G],F.push(T);else for(G=0;G<H.length;G++)T+=H[G],F.push(T);if(t.reversed)for(G=0;G<H.length;G++)F[G]<va?(a.push(M),D.push(W),ca=G):(a.push((F[G]-S+$*V)/$),D.push((F[G]-S+ea*X)/ea));else for(G=0;G<H.length;G++)F[G]<va?(a.push((F[G]-S+$*V)/$),D.push((F[G]-S+ea*X)/ea),ca=G):(a.push(M),D.push(W));for(G=0;G<H.length-1;G++)T=t.reversed?x[x.length-1-G].color?x[x.length-1-G].color:t._colorSet[(x.length-1-G)%t._colorSet.length]:x[G].color?x[G].color:t._colorSet[G%t._colorSet.length],
G===ca?P.push({x1:a[G],y1:F[G],x2:D[G],y2:F[G],x3:W,y3:va,x4:D[G+1],y4:F[G+1],x5:a[G+1],y5:F[G+1],x6:M,y6:va,id:G,height:F[G+1]-F[G],color:T}):P.push({x1:a[G],y1:F[G],x2:D[G],y2:F[G],x3:D[G+1],y3:F[G+1],x4:a[G+1],y4:F[G+1],id:G,height:F[G+1]-F[G],color:T});var da=2,I=[],ha=!1,Z=[],ga=[],H=!1;a=a=0;Aa(Z);for(G=0;G<x.length;G++)x[G].exploded&&(H=!0,t.reversed?Z.push(x.length-1-G):Z.push(G));Q.clearRect(C.x1,C.y1,C.width,C.height);Q.fillStyle=y.backgroundColor;Q.fillRect(C.x1,C.y1,C.width,C.height);
if(K&&t.visible&&(b(),f(),e(),"inside"!==t.indexLabelPlacement)){l();for(G=0;G<x.length;G++)I[G].isDirty||(a=I[G].textBlock.x+I[G].width,a=(N-a)/2,0==G&&(z=a),z>a&&(z=a));for(G=0;G<P.length;G++)P[G].x1+=z,P[G].x2+=z,P[G].x3+=z,P[G].x4+=z,P[G].x5&&(P[G].x5+=z,P[G].x6+=z),I[G].textBlock.x+=z}for(G=0;G<P.length;G++)z=P[G],oa(Q,z,t.fillOpacity),ga.push(z.y1);w(Q);K&&t.visible&&("inside"===t.indexLabelPlacement||y.animationEnabled||n(Q),y.animationEnabled||r());if(!K)for(G=0;G<x.length;G++)z=t.dataPointIds[G],
a={id:z,objectType:"dataPoint",dataPointIndex:G,dataSeriesIndex:0,funnelSection:P[t.reversed?x.length-1-G:G]},y._eventManager.objectMap[z]=a;!y.animationEnabled&&H?m(y,-1,0):y.animationEnabled&&!y.animatedRender&&m(y,-1,0);this.funnelPyramidClickHandler=function(a){var b=-1;if(!ha&&!y.isAnimating&&(s(a.dataSeries.explodeOnClick)||a.dataSeries.explodeOnClick)&&(b=t.reversed?x.length-1-a.dataPointIndex:a.dataPointIndex,0<=b)){a=b;if("funnel"===t.type||"pyramid"===t.type)t.reversed?x[x.length-1-a].exploded=
x[x.length-1-a].exploded?!1:!0:x[a].exploded=x[a].exploded?!1:!0;m(y,b,500)}};return{source:Q,dest:this.plotArea.ctx,animationCallback:function(a,b){L.fadeInAnimation(a,b);1<=a&&(m(y,-1,500),w(y.plotArea.ctx||y.ctx))},easingFunction:L.easing.easeInQuad,animationBase:0}}}}};m.prototype.requestAnimFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(a){window.setTimeout(a,
...
k=Math.max(Math.ceil(Math.log(1/Math.abs(l))/Math.LN10),2);if(isNaN(k)||!isFinite(k))k=2;for(var n=0;n<k;n++)m+="#";c.percentFormatString=m}a=a.replace("#percent",ea(l,m,f._cultureInfo));a=a.replace("#total",ea(h,c.yValueFormatString?c.yValueFormatString:"#,##0.########",f._cultureInfo))}while(0<=a.indexOf("#percent")||0<=a.indexOf("#total"))}return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g,function(a){if('"'===a[0]&&'"'===a[a.length-1]||"'"===a[0]&&"'"===a[a.length-1])return a.slice(1,a.length-1);a=Da(a.slice(1,
a.length-1));a=a.replace("#index",e);var k=null;try{var g=a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);g&&0<g.length&&(k=Da(g[2]),a=Da(g[1]))}catch(l){}g=null;if("color"===a)return"waterfall"===c.type?d.color?d.color:0<d.y?c.risingColor:c.fallingColor:"error"===c.type?c.color?c.color:c._colorSet[k%c._colorSet.length]:d.color?d.color:c.color?c.color:c._colorSet[b%c._colorSet.length];if(d.hasOwnProperty(a))g=d;else if(c.hasOwnProperty(a))g=c;else return"";g=g[a];null!==k&&(g=g[k]);if("x"===a)if(c.axisX&&"dateTime"===
...
v=p.markerSize||"line"!==p.type&&"stepLine"!==p.type&&"spline"!==p.type?0.75*this.lineHeight:0,w=p.legendMarkerBorderColor?p.legendMarkerBorderColor:p.markerBorderColor,t=p.legendMarkerBorderThickness?p.legendMarkerBorderThickness:p.markerBorderThickness?Math.max(1,Math.round(0.2*v)):0;"error"===p.type&&this.errorMarkerColor.push(r);g=this.chart.replaceKeywordsWithValue(g,p.dataPoints[0],p,n);q={markerType:q,markerColor:r,text:g,textBlock:null,chartType:p.type,markerSize:v,lineColor:p._colorSet[0],
dataSeriesIndex:p.index,dataPointIndex:null,markerBorderColor:w,markerBorderThickness:t};m.push(q)}else for(var x=0;x<p.dataPoints.length;x++){var C=p.dataPoints[x],q=C.legendMarkerType?C.legendMarkerType:p.legendMarkerType?p.legendMarkerType:H.getDefaultLegendMarker(p.type),g=C.legendText?C.legendText:p.legendText?p.legendText:this.itemTextFormatter?this.itemTextFormatter({chart:this.chart,legend:this.options,dataSeries:p,dataPoint:C}):C.name?C.name:"DataPoint: "+(x+1),r=C.legendMarkerColor?C.legendMarkerColor:
p.legendMarkerColor?p.legendMarkerColor:C.color?C.color:p.color?p.color:p._colorSet[x%p._colorSet.length],v=0.75*this.lineHeight,w=C.legendMarkerBorderColor?C.legendMarkerBorderColor:p.legendMarkerBorderColor?p.legendMarkerBorderColor:C.markerBorderColor?C.markerBorderColor:p.markerBorderColor,t=C.legendMarkerBorderThickness?C.legendMarkerBorderThickness:p.legendMarkerBorderThickness?p.legendMarkerBorderThickness:C.markerBorderThickness||p.markerBorderThickness?Math.max(1,Math.round(0.2*v)):0,g=this.chart.replaceKeywordsWithValue(g,
C,p,x),q={markerType:q,markerColor:r,text:g,textBlock:null,chartType:p.type,markerSize:v,dataSeriesIndex:n,dataPointIndex:x,markerBorderColor:w,markerBorderThickness:t};(C.showInLegend||p.showInLegend&&!1!==C.showInLegend)&&m.push(q)}}!0===this.reversed&&m.reverse();if(0<m.length){p=null;r=g=C=x=0;C=null!==this.itemWidth?null!==this.itemMaxWidth?Math.min(this.itemWidth,this.itemMaxWidth,f):this.itemMaxWidth=Math.min(this.itemWidth,f):null!==this.itemMaxWidth?Math.min(this.itemMaxWidth,f):this.itemMaxWidth=
f;v=0===v?0.75*this.lineHeight:v;C-=v+h;for(n=0;n<m.length;n++){q=m[n];w=C;if("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType)w-=2*0.1*this.lineHeight;if(!(0>=l||"undefined"===typeof l||0>=w||"undefined"===typeof w)){if("horizontal"===this.orientation){q.textBlock=new ia(this.ctx,{x:0,y:0,maxWidth:w,maxHeight:this.itemWrap?l:this.lineHeight,angle:0,text:q.text,horizontalAlign:"left",fontSize:this.fontSize,fontFamily:this.fontFamily,fontWeight:this.fontWeight,fontColor:this.fontColor,
...
q.x1&&(a<=q.x2&&d>=q.y1&&d<=q.y2)&&(b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:Math.min(Math.abs(q.x1-a),Math.abs(q.x2-a),Math.abs(q.y1-d),Math.abs(q.y2-d))}),h=!0);break;case "line":case "stepLine":case "spline":case "area":case "stepArea":case "stackedArea":case "stackedArea100":case "splineArea":case "scatter":var s=la("markerSize",g,this)||4,v=c?20:s,r=Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2));r<=v&&b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:r});q=
Math.abs(q.x1-a);q<=m?m=q:0<l?k++:n++;r<=s/2&&(h=!0);break;case "rangeArea":case "rangeSplineArea":s=la("markerSize",g,this)||4;v=c?20:s;r=Math.min(Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2)),Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y2-d,2)));r<=v&&b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:r});q=Math.abs(q.x1-a);q<=m?m=q:0<l?k++:n++;r<=s/2&&(h=!0);break;case "bubble":s=q.size;r=Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2));r<=s/2&&(b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,
...
0));N.push(x);if(d&&0<d.length)for(y=[],g=W=0;g<d.length;g++)d[g]&&(d[g].lineCoordinates={}),d[g].lineCoordinates.width=Math.abs(m-l),d[g].title&&(d[g]._titleTextBlock.maxWidth=0<d[g].titleMaxWidth&&d[g].titleMaxWidth<d[g].lineCoordinates.width?d[g].titleMaxWidth:d[g].lineCoordinates.width),y.push(Math.ceil(d[g]?d[g].createLabelsAndCalculateHeight():0)),W+=y[g],X+=d[g]&&!n.isNavigator?d[g].margin:0;else y.push(Math.ceil(d[0]?d[0].createLabelsAndCalculateHeight():0));O.push(y);if(a&&0<a.length)for(g=
...
h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle))),!a[g]||(!a[g].labelAutoFit||s(z)||s(E)||n.isNavigator||n.stockChart)||(h=0,0<a[g].labelAngle?E+t>m&&(h+=0<a[g].labelAngle?E+t-m-$:0):0>a[g].labelAngle?z-w<l&&z-w<a[g].viewportMinimum&&(F=l-(M+a[g].tickLength+B+z-w+a[g].labelFontSize/2)):0===a[g].labelAngle&&(E+t>m&&(h=E+t/2-m-$),z-w<l&&z-w<a[g].viewportMinimum&&(F=l-M-a[g].tickLength-B-z+w/2)),a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0<a[g].labelAngle&&
...
h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle))),n.panEnabled?W=s(n.sessionVariables.axisX2.height)?n.sessionVariables.axisX2.height=W:n.sessionVariables.axisX2.height:n.sessionVariables.axisX2.height=W,h=Math.round(f.y1),k=Math.round(f.y2+d[g].margin),d[g].lineCoordinates.y1=h+W+X-U,d[g].lineCoordinates.y2=h,"inside"===d[g].labelPlacement&&0<g&&(d[g].lineCoordinates.y1=d[g-1].bounds.y1-y[g]+(d[g]._titleTextBlock?d[g]._titleTextBlock.height:0)),d[g].bounds={x1:l,y1:h+(W+
X-y[g]-U),x2:m,y2:k,width:m-l,height:k-h},U+=y[g]+d[g].margin;if(c&&0<c.length)for(g=0;g<c.length;g++)M=n.isNavigator?0:10,c[g]&&(l=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),M=c[g]._labels&&0<c[g]._labels.length?c[g]._labels[c[g]._labels.length-1].textBlock.height/2:p,h=Math.round(f.y1+W+X<Math.max(M,p)?Math.max(M,p):f.y1+W+X),m=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),M=0<a.length?0:c[g]._labels&&0<c[g]._labels.length?c[g]._labels[0].textBlock.height/
2:p,k=Math.round(f.y2-T-e-M),c[g].lineCoordinates={x1:l-S,y1:h,x2:m-S,y2:k,height:Math.abs(k-h)},"inside"===c[g].labelPlacement&&0<g&&(c[g].lineCoordinates.x1=c[g].lineCoordinates.x1-(B[g]-c[g]._titleTextBlock?c[g]._titleTextBlock.height:0)+("outside"===c[g].tickPlacement?c[g].tickLength:0),c[g].lineCoordinates.x2=c[g].lineCoordinates.x1+c[g].lineThickness/2),c[g].bounds={x1:l-(B[g]+S),y1:h,x2:m,y2:k,width:m-l,height:k-h},c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<
c[g].lineCoordinates.height?c[g].titleMaxWidth:c[g].lineCoordinates.height),S+=B[g]+c[g].margin);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g]&&(l=Math.round(a[0]?a[0].lineCoordinates.x2:d[0].lineCoordinates.x2),m=Math.round(l),M=b[g]._labels&&0<b[g]._labels.length?b[g]._labels[b[g]._labels.length-1].textBlock.height/2:0,h=Math.round(f.y1+W+X<Math.max(M,p)?Math.max(M,p):f.y1+W+X),M=0<a.length?0:b[g]._labels&&0<b[g]._labels.length?b[g]._labels[0].textBlock.height/2:0,k=Math.round(f.y2-(T+e+M)),b[g].lineCoordinates=
...
b[g].lineCoordinates.height),V+=D[g]+b[g].margin);if(a&&0<a.length)for(g=0;g<a.length;g++)a[g]&&(a[g].calculateValueToPixelConversionParameters(),a[g].calculateBreaksSizeInValues(),a[g]._labels&&1<a[g]._labels.length&&(z=(a[g].logarithmic?Math.log(a[g]._labels[1].position/a[g].viewportMinimum)/a[g].conversionParameters.lnLogarithmBase:a[g]._labels[1].position-a[g].viewportMinimum)*Math.abs(a[g].conversionParameters.pixelPerUnit)+a[g].lineCoordinates.x1,l=a[g]._labels[a[g]._labels.length-("dateTime"===
...
[];z=[];F=[];w=[];E=[];t=[];N=[];for(O=[];4>v;){T=V=U=S=Z=M=X=e=R=Q=G=W=0;if(a&&0<a.length)for(F=[],g=V=0;g<a.length;g++)F.push(Math.ceil(a[g]?a[g].createLabelsAndCalculateWidth():0)),V+=F[g],e+=a[g]&&!n.isNavigator?a[g].margin:0;else F.push(Math.ceil(a[0]?a[0].createLabelsAndCalculateWidth():0));N.push(F);if(d&&0<d.length)for(w=[],g=T=0;g<d.length;g++)w.push(Math.ceil(d[g]?d[g].createLabelsAndCalculateWidth():0)),T+=w[g],X+=d[g]?d[g].margin:0;else w.push(Math.ceil(d[0]?d[0].createLabelsAndCalculateWidth():
0));O.push(w);if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].lineCoordinates={},l=Math.round(f.x1+V+e),m=Math.round(f.x2-T-X>n.width-10?n.width-10:f.x2-T-X),c[g].labelAutoFit&&!s(x)&&(0<!a.length&&(l=0>c[g].labelAngle?Math.max(l,x):0===c[g].labelAngle?Math.max(l,x/2):l),0<!d.length&&(m=0<c[g].labelAngle?m-y/2:0===c[g].labelAngle?m-y/2:m)),c[g].lineCoordinates.x1=l,c[g].lineCoordinates.x2=m,c[g].lineCoordinates.width=Math.abs(m-l),c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<
c[g].lineCoordinates.width?c[g].titleMaxWidth:c[g].lineCoordinates.width);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].lineCoordinates={},l=Math.round(f.x1+V+e),m=Math.round(f.x2-T-X>b[g].chart.width-10?b[g].chart.width-10:f.x2-T-X),b[g]&&b[g].labelAutoFit&&!s(B)&&(0<!a.length&&(l=0<b[g].labelAngle?Math.max(l,B):0===b[g].labelAngle?Math.max(l,B/2):l),0<!d.length&&(m-=D/2)),b[g].lineCoordinates.x1=l,b[g].lineCoordinates.x2=m,b[g].lineCoordinates.width=Math.abs(m-l),b[g].title&&(b[g]._titleTextBlock.maxWidth=
0<b[g].titleMaxWidth&&b[g].titleMaxWidth<b[g].lineCoordinates.width?b[g].titleMaxWidth:b[g].lineCoordinates.width);if(c&&0<c.length)for(p=[],g=S=0;g<c.length;g++)p.push(Math.ceil(c[g]?c[g].createLabelsAndCalculateHeight():0)),S+=p[g]+c[g].margin,M+=c[g].margin;else p.push(Math.ceil(c[0]?c[0].createLabelsAndCalculateHeight():0));E.push(p);if(b&&0<b.length)for(z=[],g=U=0;g<b.length;g++)z.push(Math.ceil(b[g]?b[g].createLabelsAndCalculateHeight():0)),U+=z[g],Z+=b[g].margin;else z.push(Math.ceil(b[0]?
...
0<a.getSeconds()||0<a.getMilliseconds())a.setMonth(a.getMonth()+1),a.setDate(1),a.setHours(0),a.setMinutes(0),a.setSeconds(0),a.setMilliseconds(0)}else"year"===this.intervalType&&(0<a.getMonth()||1<a.getDate()||0<a.getHours()||0<a.getMinutes()||0<a.getSeconds()||0<a.getMilliseconds())&&(a.setFullYear(a.getFullYear()+1),a.setMonth(0),a.setDate(1),a.setHours(0),a.setMinutes(0),a.setSeconds(0),a.setMilliseconds(0));return a};na(S,V);na(T,V);T.prototype.createUserOptions=function(a){if("undefined"!==
...
this.parent.dataSeries[w].getDataPointAtX(r,!0))&&0<=v.index&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.x}):s(this.options.label)?v.dataPoint.label:this.label)}else"dateTime"===this.parent.valueType?k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.x}):s(this.options.label)?ya(c?c:x.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):
...
value:x.dataPoint.x}):s(this.options.label)?ya(c?c:x.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.x}):s(this.options.label)?ea(c?c:x.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label);this.value=x.dataPoint.x;k.x=b-k.measureText().width/2;k.x+k.width>this.chart.bounds.x2&&(k.x=this.chart.bounds.x2-
...
(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(a)}):s(this.options.label)?v.dataPoint.label:this.label)}else"dateTime"===this.parent.valueType?k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(d)}):s(this.options.label)?ya(c?c:this.parent.convertPixelToValue(d),this.valueFormatString,this.chart._cultureInfo):
...
this.parent.valueType?k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(a)}):s(this.options.label)?ya(c?c:this.parent.convertPixelToValue(a),this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:0<this.parent.dataSeries.length?this.parent.convertPixelToValue(a):
...
"top"===this.parent._position)this._updatedValue=this.parent.convertPixelToValue(h);if("left"===this.parent._position||"right"===this.parent._position)this._updatedValue=this.parent.convertPixelToValue(m);q.globalAlpha=g};na(X,V);X.prototype._initialize=function(){this.updateOption("updated");this.updateOption("hidden");if(this.enabled){this.container=document.createElement("div");this.container.setAttribute("class","canvasjs-chart-tooltip");this.container.style.position="absolute";this.container.style.height=
...
this.enabled||(this.hide(),this.dispatchEvent("hidden",{chart:this.chart,toolTip:this},this));if(!this.chart.disableToolTip){if("undefined"===typeof a||"undefined"===typeof d){if(isNaN(this._prevX)||isNaN(this._prevY))return;a=this._prevX;d=this._prevY}else this._prevX=a,this._prevY=d;var b=null,e=null,f=[],h=0;if(this.shared&&this.enabled&&"none"!==this.chart.plotInfo.axisPlacement){if("xySwapped"===this.chart.plotInfo.axisPlacement){var m=[];if(this.chart.axisX)for(var w=0;w<this.chart.axisX.length;w++){for(var h=
this.chart.axisX[w].convertPixelToValue({y:d}),k=null,b=0;b<this.chart.axisX[w].dataSeries.length;b++)(k=this.chart.axisX[w].dataSeries[b].getDataPointAtX(h,c))&&0<=k.index&&(k.dataSeries=this.chart.axisX[w].dataSeries[b],null!==k.dataPoint.y&&m.push(k));k=null}if(this.chart.axisX2)for(w=0;w<this.chart.axisX2.length;w++){h=this.chart.axisX2[w].convertPixelToValue({y:d});k=null;for(b=0;b<this.chart.axisX2[w].dataSeries.length;b++)(k=this.chart.axisX2[w].dataSeries[b].getDataPointAtX(h,c))&&0<=k.index&&
(k.dataSeries=this.chart.axisX2[w].dataSeries[b],null!==k.dataPoint.y&&m.push(k));k=null}}else{m=[];if(this.chart.axisX)for(w=0;w<this.chart.axisX.length;w++)for(h=this.chart.axisX[w].convertPixelToValue({x:a}),k=null,b=0;b<this.chart.axisX[w].dataSeries.length;b++)(k=this.chart.axisX[w].dataSeries[b].getDataPointAtX(h,c))&&0<=k.index&&(k.dataSeries=this.chart.axisX[w].dataSeries[b],null!==k.dataPoint.y&&m.push(k));if(this.chart.axisX2)for(w=0;w<this.chart.axisX2.length;w++)for(h=this.chart.axisX2[w].convertPixelToValue({x:a}),
k=null,b=0;b<this.chart.axisX2[w].dataSeries.length;b++)(k=this.chart.axisX2[w].dataSeries[b].getDataPointAtX(h,c))&&0<=k.index&&(k.dataSeries=this.chart.axisX2[w].dataSeries[b],null!==k.dataPoint.y&&m.push(k))}if(0===m.length)return;m.sort(function(a,b){return a.distance-b.distance});c=m[0];for(b=0;b<m.length;b++)m[b].dataPoint.x.valueOf()===c.dataPoint.x.valueOf()&&f.push(m[b]);m=null}else{if(k=this.chart.getDataPointAtXY(a,d,c))this.currentDataPointIndex=k.dataPointIndex,this.currentSeriesIndex=
k.dataSeries.index;else if(v)if(k=Wa(a,d,this.chart._eventManager.ghostCtx),0<k&&"undefined"!==typeof this.chart._eventManager.objectMap[k]){k=this.chart._eventManager.objectMap[k];if("legendItem"===k.objectType)return;this.currentSeriesIndex=k.dataSeriesIndex;this.currentDataPointIndex=0<=k.dataPointIndex?k.dataPointIndex:-1}else this.currentDataPointIndex=-1;else this.currentDataPointIndex=-1;if(0<=this.currentSeriesIndex){e=this.chart.data[this.currentSeriesIndex];k={};if(0<=this.currentDataPointIndex)b=
...
c.size,c.color,c.borderColor,c.borderThickness)}}};return m}();y.version="v3.4 GA";window.CanvasJS&&(y&&!window.CanvasJS.Chart)&&(window.CanvasJS.Chart=y)})();
